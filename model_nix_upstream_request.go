...
// checks if the NixUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NixUpstreamRequest{}

// NixUpstreamRequest struct for NixUpstreamRequest
type NixUpstreamRequest struct {
...
type _NixUpstreamRequest NixUpstreamRequest
...
func (o *NixUpstreamRequest) SetAuthSecretNil() {
...
func (o *NixUpstreamRequest) SetAuthUsernameNil() {
...
func (o *NixUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *NixUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *NixUpstreamRequest) SetExtraValue1Nil() {
...
func (o *NixUpstreamRequest) SetExtraValue2Nil() {
...
func (o NixUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o NixUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *NixUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varNixUpstreamRequest := _NixUpstreamRequest{}

	err = json.Unmarshal(data, &varNixUpstreamRequest)

	if err != nil {
		return err
	}

	*o = NixUpstreamRequest(varNixUpstreamRequest)
...
type NullableNixUpstreamRequest struct {
	value *NixUpstreamRequest
	isSet bool
}

func (v NullableNixUpstreamRequest) Get() *NixUpstreamRequest {
	return v.value
}

func (v *NullableNixUpstreamRequest) Set(val *NixUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableNixUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableNixUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNixUpstreamRequest(val *NixUpstreamRequest) *NullableNixUpstreamRequest {
	return &NullableNixUpstreamRequest{value: val, isSet: true}
}

func (v NullableNixUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNixUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
