...
// checks if the PythonPackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PythonPackageUpload{}
...
type _PythonPackageUpload PythonPackageUpload
...
func (o *PythonPackageUpload) SetDependenciesChecksumMd5Nil() {
...
func (o *PythonPackageUpload) SetDescriptionNil() {
...
func (o *PythonPackageUpload) SetEpochNil() {
	o.Epoch.Set(nil)
}
...
func (o *PythonPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *PythonPackageUpload) SetLicenseNil() {
	o.License.Set(nil)
}
...
func (o *PythonPackageUpload) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *PythonPackageUpload) SetRawLicenseNil() {
...
func (o *PythonPackageUpload) SetReleaseNil() {
	o.Release.Set(nil)
}
...
func (o *PythonPackageUpload) SetSecurityScanCompletedAtNil() {
...
func (o *PythonPackageUpload) SetSecurityScanStartedAtNil() {
...
func (o *PythonPackageUpload) SetSecurityScanStatusUpdatedAtNil() {
...
func (o *PythonPackageUpload) SetSpdxLicenseNil() {
...
func (o *PythonPackageUpload) SetStatusReasonNil() {
...
func (o *PythonPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *PythonPackageUpload) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *PythonPackageUpload) SetSyncFinishedAtNil() {
...
func (o *PythonPackageUpload) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o *PythonPackageUpload) SetVulnerabilityCountsNil() {
...
func (o PythonPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *PythonPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varPythonPackageUpload := _PythonPackageUpload{}

	err = json.Unmarshal(data, &varPythonPackageUpload)

	if err != nil {
		return err
	}

	*o = PythonPackageUpload(varPythonPackageUpload)
