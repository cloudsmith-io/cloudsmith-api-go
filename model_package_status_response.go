...
// PackageStatusResponse struct for PackageStatusResponse
...
func (o PackageStatusResponse) MarshalJSON() ([]byte, error) {
...
type NullablePackageStatusResponse struct {
	value *PackageStatusResponse
	isSet bool
}

func (v NullablePackageStatusResponse) Get() *PackageStatusResponse {
	return v.value
}

func (v *NullablePackageStatusResponse) Set(val *PackageStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageStatusResponse(val *PackageStatusResponse) *NullablePackageStatusResponse {
	return &NullablePackageStatusResponse{value: val, isSet: true}
}

func (v NullablePackageStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
