...
// checks if the NixUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NixUpstreamRequestPatch{}

// NixUpstreamRequestPatch struct for NixUpstreamRequestPatch
type NixUpstreamRequestPatch struct {
...
type _NixUpstreamRequestPatch NixUpstreamRequestPatch
...
func (o *NixUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *NixUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *NixUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *NixUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *NixUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *NixUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o NixUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o NixUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *NixUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varNixUpstreamRequestPatch := _NixUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varNixUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = NixUpstreamRequestPatch(varNixUpstreamRequestPatch)
...
type NullableNixUpstreamRequestPatch struct {
	value *NixUpstreamRequestPatch
	isSet bool
}

func (v NullableNixUpstreamRequestPatch) Get() *NixUpstreamRequestPatch {
	return v.value
}

func (v *NullableNixUpstreamRequestPatch) Set(val *NixUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableNixUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableNixUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNixUpstreamRequestPatch(val *NixUpstreamRequestPatch) *NullableNixUpstreamRequestPatch {
	return &NullableNixUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableNixUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNixUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
