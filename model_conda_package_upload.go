...
type _CondaPackageUpload CondaPackageUpload
...
func (o *CondaPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *CondaPackageUpload) SetRawLicenseNil() {
...
func (o *CondaPackageUpload) SetSpdxLicenseNil() {
...
func (o *CondaPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *CondaPackageUpload) SetVulnerabilityCountsNil() {
...
func (o *CondaPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varCondaPackageUpload := _CondaPackageUpload{}

	err = json.Unmarshal(data, &varCondaPackageUpload)

	if err != nil {
		return err
	}

	*o = CondaPackageUpload(varCondaPackageUpload)
