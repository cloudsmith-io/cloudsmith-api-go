...
func (o *CranPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *CranPackageUpload) SetLicenseNil() {
	o.License.Set(nil)
}
...
func (o *CranPackageUpload) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *CranPackageUpload) SetRawLicenseNil() {
...
func (o *CranPackageUpload) SetReleaseNil() {
	o.Release.Set(nil)
}
...
func (o *CranPackageUpload) SetSecurityScanCompletedAtNil() {
...
func (o *CranPackageUpload) SetSecurityScanStartedAtNil() {
...
func (o *CranPackageUpload) SetSecurityScanStatusNil() {
...
func (o *CranPackageUpload) SetSecurityScanStatusUpdatedAtNil() {
...
func (o *CranPackageUpload) SetSignatureUrlNil() {
...
func (o *CranPackageUpload) SetSpdxLicenseNil() {
...
func (o *CranPackageUpload) SetStatusReasonNil() {
...
func (o *CranPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *CranPackageUpload) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *CranPackageUpload) SetSyncFinishedAtNil() {
...
func (o *CranPackageUpload) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o *CranPackageUpload) SetVulnerabilityCountsNil() {
...
func (o CranPackageUpload) MarshalJSON() ([]byte, error) {
...
func (o CranPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *CranPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varCranPackageUpload := _CranPackageUpload{}

	err = json.Unmarshal(data, &varCranPackageUpload)

	if err != nil {
		return err
	}

	*o = CranPackageUpload(varCranPackageUpload)
...
type NullableCranPackageUpload struct {
	value *CranPackageUpload
	isSet bool
}

func (v NullableCranPackageUpload) Get() *CranPackageUpload {
	return v.value
}

func (v *NullableCranPackageUpload) Set(val *CranPackageUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableCranPackageUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableCranPackageUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCranPackageUpload(val *CranPackageUpload) *NullableCranPackageUpload {
	return &NullableCranPackageUpload{value: val, isSet: true}
}

func (v NullableCranPackageUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCranPackageUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
