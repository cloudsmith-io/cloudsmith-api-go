...
// checks if the NpmUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NpmUpstreamRequestPatch{}
...
type _NpmUpstreamRequestPatch NpmUpstreamRequestPatch
...
func (o NpmUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *NpmUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varNpmUpstreamRequestPatch := _NpmUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varNpmUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = NpmUpstreamRequestPatch(varNpmUpstreamRequestPatch)
