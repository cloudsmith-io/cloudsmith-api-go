...
type _DartPackageUpload DartPackageUpload
...
func (o *DartPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *DartPackageUpload) SetRawLicenseNil() {
...
func (o *DartPackageUpload) SetSpdxLicenseNil() {
...
func (o *DartPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *DartPackageUpload) SetVulnerabilityCountsNil() {
...
func (o *DartPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varDartPackageUpload := _DartPackageUpload{}

	err = json.Unmarshal(data, &varDartPackageUpload)

	if err != nil {
		return err
	}

	*o = DartPackageUpload(varDartPackageUpload)
