...
func (o PackagesUploadConan) MarshalJSON() ([]byte, error) {
...
type NullablePackagesUploadConan struct {
	value *PackagesUploadConan
	isSet bool
}

func (v NullablePackagesUploadConan) Get() *PackagesUploadConan {
	return v.value
}

func (v *NullablePackagesUploadConan) Set(val *PackagesUploadConan) {
	v.value = val
	v.isSet = true
}

func (v NullablePackagesUploadConan) IsSet() bool {
	return v.isSet
}

func (v *NullablePackagesUploadConan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackagesUploadConan(val *PackagesUploadConan) *NullablePackagesUploadConan {
	return &NullablePackagesUploadConan{value: val, isSet: true}
}

func (v NullablePackagesUploadConan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackagesUploadConan) UnmarshalJSON(src []byte) error {
	v.isSet = true
