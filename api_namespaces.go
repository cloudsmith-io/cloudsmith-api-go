...
// NamespacesListOpts Optional parameters for the method 'NamespacesList'
type NamespacesListOpts struct {
	Page     optional.Int64
 ...
 * @param optional nil or *NamespacesListOpts - Optional Parameters:
...
@return []Namespace
*/
func (a *NamespacesApiService) NamespacesList(ctx _context.Context, localVarOptionals *NamespacesListOpts) ([]Namespace, *_nethttp.Response, error) {
	var (
...
@return Namespace
*/
func (a *NamespacesApiService) NamespacesRead(ctx _context.Context, slug string) (Namespace, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
