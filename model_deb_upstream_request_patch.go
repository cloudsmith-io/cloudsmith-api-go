...
// checks if the DebUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DebUpstreamRequestPatch{}

// DebUpstreamRequestPatch struct for DebUpstreamRequestPatch
type DebUpstreamRequestPatch struct {
	...
	DistroVersions []string `json:"distro_versions,omitempty"`
...
type _DebUpstreamRequestPatch DebUpstreamRequestPatch
...
func (o *DebUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *DebUpstreamRequestPatch) SetAuthUsernameNil() {
...
// GetDistroVersions returns the DistroVersions field value if set, zero value otherwise.
func (o *DebUpstreamRequestPatch) GetDistroVersions() []string {
	if o == nil || IsNil(o.DistroVersions) {
		var ret []string
		return ret
	}
...
// GetDistroVersionsOk returns a tuple with the DistroVersions field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDistroVersions gets a reference to the given []string and assigns it to the DistroVersions field.
...
func (o *DebUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *DebUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *DebUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *DebUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o *DebUpstreamRequestPatch) SetUpstreamDistributionNil() {
...
func (o DebUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o DebUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *DebUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varDebUpstreamRequestPatch := _DebUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varDebUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = DebUpstreamRequestPatch(varDebUpstreamRequestPatch)
...
type NullableDebUpstreamRequestPatch struct {
	value *DebUpstreamRequestPatch
	isSet bool
}

func (v NullableDebUpstreamRequestPatch) Get() *DebUpstreamRequestPatch {
	return v.value
}

func (v *NullableDebUpstreamRequestPatch) Set(val *DebUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableDebUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableDebUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebUpstreamRequestPatch(val *DebUpstreamRequestPatch) *NullableDebUpstreamRequestPatch {
	return &NullableDebUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableDebUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
