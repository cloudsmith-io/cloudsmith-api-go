...
// checks if the OrganizationMembershipRoleUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationMembershipRoleUpdate{}

// OrganizationMembershipRoleUpdate struct for OrganizationMembershipRoleUpdate
...
type _OrganizationMembershipRoleUpdate OrganizationMembershipRoleUpdate
...
func NewOrganizationMembershipRoleUpdate() *OrganizationMembershipRoleUpdate {
	this := OrganizationMembershipRoleUpdate{}
...
func (o *OrganizationMembershipRoleUpdate) SetLastLoginAtNil() {
...
func (o OrganizationMembershipRoleUpdate) MarshalJSON() ([]byte, error) {
...
func (o OrganizationMembershipRoleUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationMembershipRoleUpdate) UnmarshalJSON(data []byte) (err error) {
	varOrganizationMembershipRoleUpdate := _OrganizationMembershipRoleUpdate{}

	err = json.Unmarshal(data, &varOrganizationMembershipRoleUpdate)

	if err != nil {
		return err
	}

	*o = OrganizationMembershipRoleUpdate(varOrganizationMembershipRoleUpdate)
...
type NullableOrganizationMembershipRoleUpdate struct {
	value *OrganizationMembershipRoleUpdate
	isSet bool
}

func (v NullableOrganizationMembershipRoleUpdate) Get() *OrganizationMembershipRoleUpdate {
	return v.value
}

func (v *NullableOrganizationMembershipRoleUpdate) Set(val *OrganizationMembershipRoleUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationMembershipRoleUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationMembershipRoleUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationMembershipRoleUpdate(val *OrganizationMembershipRoleUpdate) *NullableOrganizationMembershipRoleUpdate {
	return &NullableOrganizationMembershipRoleUpdate{value: val, isSet: true}
}

func (v NullableOrganizationMembershipRoleUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationMembershipRoleUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
