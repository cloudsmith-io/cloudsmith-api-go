...
// checks if the CargoUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CargoUpstreamRequest{}

// CargoUpstreamRequest struct for CargoUpstreamRequest
type CargoUpstreamRequest struct {
...
type _CargoUpstreamRequest CargoUpstreamRequest
...
func (o *CargoUpstreamRequest) SetAuthSecretNil() {
...
func (o *CargoUpstreamRequest) SetAuthUsernameNil() {
...
func (o *CargoUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *CargoUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *CargoUpstreamRequest) SetExtraValue1Nil() {
...
func (o *CargoUpstreamRequest) SetExtraValue2Nil() {
...
func (o CargoUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o CargoUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CargoUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCargoUpstreamRequest := _CargoUpstreamRequest{}

	err = json.Unmarshal(data, &varCargoUpstreamRequest)

	if err != nil {
		return err
	}

	*o = CargoUpstreamRequest(varCargoUpstreamRequest)
...
type NullableCargoUpstreamRequest struct {
	value *CargoUpstreamRequest
	isSet bool
}

func (v NullableCargoUpstreamRequest) Get() *CargoUpstreamRequest {
	return v.value
}

func (v *NullableCargoUpstreamRequest) Set(val *CargoUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCargoUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCargoUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCargoUpstreamRequest(val *CargoUpstreamRequest) *NullableCargoUpstreamRequest {
	return &NullableCargoUpstreamRequest{value: val, isSet: true}
}

func (v NullableCargoUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCargoUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
