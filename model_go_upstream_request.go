...
// checks if the GoUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GoUpstreamRequest{}

// GoUpstreamRequest struct for GoUpstreamRequest
type GoUpstreamRequest struct {
...
type _GoUpstreamRequest GoUpstreamRequest
...
func (o *GoUpstreamRequest) SetAuthSecretNil() {
...
func (o *GoUpstreamRequest) SetAuthUsernameNil() {
...
func (o *GoUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *GoUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *GoUpstreamRequest) SetExtraValue1Nil() {
...
func (o *GoUpstreamRequest) SetExtraValue2Nil() {
...
func (o GoUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o GoUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GoUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGoUpstreamRequest := _GoUpstreamRequest{}

	err = json.Unmarshal(data, &varGoUpstreamRequest)

	if err != nil {
		return err
	}

	*o = GoUpstreamRequest(varGoUpstreamRequest)
...
type NullableGoUpstreamRequest struct {
	value *GoUpstreamRequest
	isSet bool
}

func (v NullableGoUpstreamRequest) Get() *GoUpstreamRequest {
	return v.value
}

func (v *NullableGoUpstreamRequest) Set(val *GoUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGoUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGoUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoUpstreamRequest(val *GoUpstreamRequest) *NullableGoUpstreamRequest {
	return &NullableGoUpstreamRequest{value: val, isSet: true}
}

func (v NullableGoUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
