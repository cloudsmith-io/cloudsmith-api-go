...
// checks if the NugetUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NugetUpstream{}

// NugetUpstream struct for NugetUpstream
type NugetUpstream struct {
...
type _NugetUpstream NugetUpstream
...
func (o *NugetUpstream) SetAuthSecretNil() {
...
func (o *NugetUpstream) SetAuthUsernameNil() {
...
func (o *NugetUpstream) SetExtraHeader1Nil() {
...
func (o *NugetUpstream) SetExtraHeader2Nil() {
...
func (o *NugetUpstream) SetExtraValue1Nil() {
...
func (o *NugetUpstream) SetExtraValue2Nil() {
...
func (o *NugetUpstream) SetIndexPackageCountNil() {
...
func (o *NugetUpstream) SetLastIndexedNil() {
...
func (o NugetUpstream) MarshalJSON() ([]byte, error) {
...
func (o NugetUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *NugetUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varNugetUpstream := _NugetUpstream{}

	err = json.Unmarshal(data, &varNugetUpstream)

	if err != nil {
		return err
	}

	*o = NugetUpstream(varNugetUpstream)
...
type NullableNugetUpstream struct {
	value *NugetUpstream
	isSet bool
}

func (v NullableNugetUpstream) Get() *NugetUpstream {
	return v.value
}

func (v *NullableNugetUpstream) Set(val *NugetUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableNugetUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableNugetUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNugetUpstream(val *NugetUpstream) *NullableNugetUpstream {
	return &NullableNugetUpstream{value: val, isSet: true}
}

func (v NullableNugetUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNugetUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
