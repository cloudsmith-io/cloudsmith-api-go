...
type _ComposerPackageUpload ComposerPackageUpload
...
func (o *ComposerPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *ComposerPackageUpload) SetRawLicenseNil() {
...
func (o *ComposerPackageUpload) SetSpdxLicenseNil() {
...
func (o *ComposerPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *ComposerPackageUpload) SetVulnerabilityCountsNil() {
...
func (o *ComposerPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varComposerPackageUpload := _ComposerPackageUpload{}

	err = json.Unmarshal(data, &varComposerPackageUpload)

	if err != nil {
		return err
	}

	*o = ComposerPackageUpload(varComposerPackageUpload)
