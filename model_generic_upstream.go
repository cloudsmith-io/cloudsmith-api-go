...
// checks if the GenericUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericUpstream{}

// GenericUpstream struct for GenericUpstream
...
type _GenericUpstream GenericUpstream
...
func (o *GenericUpstream) SetAuthSecretNil() {
...
func (o *GenericUpstream) SetAuthUsernameNil() {
...
func (o *GenericUpstream) SetExtraHeader1Nil() {
...
func (o *GenericUpstream) SetExtraHeader2Nil() {
...
func (o *GenericUpstream) SetExtraValue1Nil() {
...
func (o *GenericUpstream) SetExtraValue2Nil() {
...
func (o *GenericUpstream) SetIndexPackageCountNil() {
...
func (o *GenericUpstream) SetIndexStatusNil() {
...
func (o *GenericUpstream) SetLastIndexedNil() {
...
func (o GenericUpstream) MarshalJSON() ([]byte, error) {
...
func (o GenericUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *GenericUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varGenericUpstream := _GenericUpstream{}

	err = json.Unmarshal(data, &varGenericUpstream)

	if err != nil {
		return err
	}

	*o = GenericUpstream(varGenericUpstream)
...
type NullableGenericUpstream struct {
	value *GenericUpstream
	isSet bool
}

func (v NullableGenericUpstream) Get() *GenericUpstream {
	return v.value
}

func (v *NullableGenericUpstream) Set(val *GenericUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableGenericUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableGenericUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenericUpstream(val *GenericUpstream) *NullableGenericUpstream {
	return &NullableGenericUpstream{value: val, isSet: true}
}

func (v NullableGenericUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenericUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
