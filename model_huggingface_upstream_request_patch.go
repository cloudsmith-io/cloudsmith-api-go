...
// checks if the HuggingfaceUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HuggingfaceUpstreamRequestPatch{}

// HuggingfaceUpstreamRequestPatch struct for HuggingfaceUpstreamRequestPatch
type HuggingfaceUpstreamRequestPatch struct {
...
type _HuggingfaceUpstreamRequestPatch HuggingfaceUpstreamRequestPatch
...
func NewHuggingfaceUpstreamRequestPatch() *HuggingfaceUpstreamRequestPatch {
	this := HuggingfaceUpstreamRequestPatch{}
...
func (o *HuggingfaceUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *HuggingfaceUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *HuggingfaceUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *HuggingfaceUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *HuggingfaceUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *HuggingfaceUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o HuggingfaceUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o HuggingfaceUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *HuggingfaceUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varHuggingfaceUpstreamRequestPatch := _HuggingfaceUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varHuggingfaceUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = HuggingfaceUpstreamRequestPatch(varHuggingfaceUpstreamRequestPatch)
...
type NullableHuggingfaceUpstreamRequestPatch struct {
	value *HuggingfaceUpstreamRequestPatch
	isSet bool
}

func (v NullableHuggingfaceUpstreamRequestPatch) Get() *HuggingfaceUpstreamRequestPatch {
	return v.value
}

func (v *NullableHuggingfaceUpstreamRequestPatch) Set(val *HuggingfaceUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableHuggingfaceUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableHuggingfaceUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHuggingfaceUpstreamRequestPatch(val *HuggingfaceUpstreamRequestPatch) *NullableHuggingfaceUpstreamRequestPatch {
	return &NullableHuggingfaceUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableHuggingfaceUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHuggingfaceUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
