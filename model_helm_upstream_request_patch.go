...
// checks if the HelmUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelmUpstreamRequestPatch{}

// HelmUpstreamRequestPatch struct for HelmUpstreamRequestPatch
type HelmUpstreamRequestPatch struct {
...
type _HelmUpstreamRequestPatch HelmUpstreamRequestPatch
...
func (o *HelmUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *HelmUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *HelmUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *HelmUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *HelmUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *HelmUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o HelmUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o HelmUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *HelmUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varHelmUpstreamRequestPatch := _HelmUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varHelmUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = HelmUpstreamRequestPatch(varHelmUpstreamRequestPatch)
...
type NullableHelmUpstreamRequestPatch struct {
	value *HelmUpstreamRequestPatch
	isSet bool
}

func (v NullableHelmUpstreamRequestPatch) Get() *HelmUpstreamRequestPatch {
	return v.value
}

func (v *NullableHelmUpstreamRequestPatch) Set(val *HelmUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableHelmUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableHelmUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelmUpstreamRequestPatch(val *HelmUpstreamRequestPatch) *NullableHelmUpstreamRequestPatch {
	return &NullableHelmUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableHelmUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelmUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
