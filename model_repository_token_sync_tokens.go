...
func NewRepositoryTokenSyncTokens() *RepositoryTokenSyncTokens {
	this := RepositoryTokenSyncTokens{}
	return &this
}
...
func (o RepositoryTokenSyncTokens) MarshalJSON() ([]byte, error) {
...
type NullableRepositoryTokenSyncTokens struct {
	value *RepositoryTokenSyncTokens
	isSet bool
}

func (v NullableRepositoryTokenSyncTokens) Get() *RepositoryTokenSyncTokens {
	return v.value
}

func (v *NullableRepositoryTokenSyncTokens) Set(val *RepositoryTokenSyncTokens) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoryTokenSyncTokens) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoryTokenSyncTokens) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoryTokenSyncTokens(val *RepositoryTokenSyncTokens) *NullableRepositoryTokenSyncTokens {
	return &NullableRepositoryTokenSyncTokens{value: val, isSet: true}
}

func (v NullableRepositoryTokenSyncTokens) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoryTokenSyncTokens) UnmarshalJSON(src []byte) error {
	v.isSet = true
