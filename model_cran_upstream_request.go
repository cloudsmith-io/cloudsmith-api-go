...
// checks if the CranUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CranUpstreamRequest{}

// CranUpstreamRequest struct for CranUpstreamRequest
type CranUpstreamRequest struct {
...
type _CranUpstreamRequest CranUpstreamRequest
...
func (o *CranUpstreamRequest) SetAuthSecretNil() {
...
func (o *CranUpstreamRequest) SetAuthUsernameNil() {
...
func (o *CranUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *CranUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *CranUpstreamRequest) SetExtraValue1Nil() {
...
func (o *CranUpstreamRequest) SetExtraValue2Nil() {
...
func (o CranUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o CranUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CranUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCranUpstreamRequest := _CranUpstreamRequest{}

	err = json.Unmarshal(data, &varCranUpstreamRequest)

	if err != nil {
		return err
	}

	*o = CranUpstreamRequest(varCranUpstreamRequest)
...
type NullableCranUpstreamRequest struct {
	value *CranUpstreamRequest
	isSet bool
}

func (v NullableCranUpstreamRequest) Get() *CranUpstreamRequest {
	return v.value
}

func (v *NullableCranUpstreamRequest) Set(val *CranUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCranUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCranUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCranUpstreamRequest(val *CranUpstreamRequest) *NullableCranUpstreamRequest {
	return &NullableCranUpstreamRequest{value: val, isSet: true}
}

func (v NullableCranUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCranUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
