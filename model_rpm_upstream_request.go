...
type _RpmUpstreamRequest RpmUpstreamRequest
...
func (o *RpmUpstreamRequest) SetGpgKeyInlineNil() {
...
func (o *RpmUpstreamRequest) SetGpgKeyUrlNil() {
	o.GpgKeyUrl.Set(nil)
}
...
func (o *RpmUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRpmUpstreamRequest := _RpmUpstreamRequest{}

	err = json.Unmarshal(data, &varRpmUpstreamRequest)

	if err != nil {
		return err
	}

	*o = RpmUpstreamRequest(varRpmUpstreamRequest)
