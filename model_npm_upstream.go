...
// checks if the NpmUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NpmUpstream{}

// NpmUpstream struct for NpmUpstream
...
func (o *NpmUpstream) SetAuthSecretNil() {
...
func (o *NpmUpstream) SetAuthUsernameNil() {
...
func (o *NpmUpstream) SetExtraHeader1Nil() {
...
func (o *NpmUpstream) SetExtraHeader2Nil() {
...
func (o *NpmUpstream) SetExtraValue1Nil() {
...
func (o *NpmUpstream) SetExtraValue2Nil() {
...
func (o *NpmUpstream) SetIndexPackageCountNil() {
...
func (o *NpmUpstream) SetIndexStatusNil() {
...
func (o *NpmUpstream) SetLastIndexedNil() {
...
func (o NpmUpstream) MarshalJSON() ([]byte, error) {
...
func (o NpmUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *NpmUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varNpmUpstream := _NpmUpstream{}

	err = json.Unmarshal(data, &varNpmUpstream)

	if err != nil {
		return err
	}

	*o = NpmUpstream(varNpmUpstream)
...
type NullableNpmUpstream struct {
	value *NpmUpstream
	isSet bool
}

func (v NullableNpmUpstream) Get() *NpmUpstream {
	return v.value
}

func (v *NullableNpmUpstream) Set(val *NpmUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableNpmUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableNpmUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNpmUpstream(val *NpmUpstream) *NullableNpmUpstream {
	return &NullableNpmUpstream{value: val, isSet: true}
}

func (v NullableNpmUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNpmUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
