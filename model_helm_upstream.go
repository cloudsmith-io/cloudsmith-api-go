...
// checks if the HelmUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelmUpstream{}

// HelmUpstream struct for HelmUpstream
type HelmUpstream struct {
...
type _HelmUpstream HelmUpstream
...
func (o *HelmUpstream) SetAuthSecretNil() {
...
func (o *HelmUpstream) SetAuthUsernameNil() {
...
func (o *HelmUpstream) SetExtraHeader1Nil() {
...
func (o *HelmUpstream) SetExtraHeader2Nil() {
...
func (o *HelmUpstream) SetExtraValue1Nil() {
...
func (o *HelmUpstream) SetExtraValue2Nil() {
...
func (o *HelmUpstream) SetIndexPackageCountNil() {
...
func (o *HelmUpstream) SetIndexStatusNil() {
...
func (o *HelmUpstream) SetLastIndexedNil() {
...
func (o HelmUpstream) MarshalJSON() ([]byte, error) {
...
func (o HelmUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *HelmUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varHelmUpstream := _HelmUpstream{}

	err = json.Unmarshal(data, &varHelmUpstream)

	if err != nil {
		return err
	}

	*o = HelmUpstream(varHelmUpstream)
...
type NullableHelmUpstream struct {
	value *HelmUpstream
	isSet bool
}

func (v NullableHelmUpstream) Get() *HelmUpstream {
	return v.value
}

func (v *NullableHelmUpstream) Set(val *HelmUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableHelmUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableHelmUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelmUpstream(val *HelmUpstream) *NullableHelmUpstream {
	return &NullableHelmUpstream{value: val, isSet: true}
}

func (v NullableHelmUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelmUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
