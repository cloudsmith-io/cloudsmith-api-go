...
// checks if the NugetUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NugetUpstreamRequest{}

// NugetUpstreamRequest struct for NugetUpstreamRequest
type NugetUpstreamRequest struct {
...
type _NugetUpstreamRequest NugetUpstreamRequest
...
func (o *NugetUpstreamRequest) SetAuthSecretNil() {
...
func (o *NugetUpstreamRequest) SetAuthUsernameNil() {
...
func (o *NugetUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *NugetUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *NugetUpstreamRequest) SetExtraValue1Nil() {
...
func (o *NugetUpstreamRequest) SetExtraValue2Nil() {
...
func (o NugetUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o NugetUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *NugetUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varNugetUpstreamRequest := _NugetUpstreamRequest{}

	err = json.Unmarshal(data, &varNugetUpstreamRequest)

	if err != nil {
		return err
	}

	*o = NugetUpstreamRequest(varNugetUpstreamRequest)
...
type NullableNugetUpstreamRequest struct {
	value *NugetUpstreamRequest
	isSet bool
}

func (v NullableNugetUpstreamRequest) Get() *NugetUpstreamRequest {
	return v.value
}

func (v *NullableNugetUpstreamRequest) Set(val *NugetUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableNugetUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableNugetUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNugetUpstreamRequest(val *NugetUpstreamRequest) *NullableNugetUpstreamRequest {
	return &NullableNugetUpstreamRequest{value: val, isSet: true}
}

func (v NullableNugetUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNugetUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
