...
// RepositoryCreateResponse struct for RepositoryCreateResponse
...
func (o *RepositoryCreateResponse) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o RepositoryCreateResponse) MarshalJSON() ([]byte, error) {
...
type NullableRepositoryCreateResponse struct {
	value *RepositoryCreateResponse
	isSet bool
}

func (v NullableRepositoryCreateResponse) Get() *RepositoryCreateResponse {
	return v.value
}

func (v *NullableRepositoryCreateResponse) Set(val *RepositoryCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoryCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoryCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoryCreateResponse(val *RepositoryCreateResponse) *NullableRepositoryCreateResponse {
	return &NullableRepositoryCreateResponse{value: val, isSet: true}
}

func (v NullableRepositoryCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoryCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
