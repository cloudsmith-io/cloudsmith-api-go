...
func (o *DebUpstream) SetIndexPackageCountNil() {
...
func (o *DebUpstream) SetIndexStatusNil() {
...
func (o *DebUpstream) SetLastIndexedNil() {
...
func (o *DebUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varDebUpstream := _DebUpstream{}

	err = json.Unmarshal(data, &varDebUpstream)

	if err != nil {
		return err
	}

	*o = DebUpstream(varDebUpstream)
