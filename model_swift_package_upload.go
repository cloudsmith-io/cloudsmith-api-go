...
func (o *SwiftPackageUpload) SetRawLicenseNil() {
...
func (o *SwiftPackageUpload) SetSpdxLicenseNil() {
...
func (o *SwiftPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *SwiftPackageUpload) SetVulnerabilityCountsNil() {
...
func (o *SwiftPackageUpload) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSwiftPackageUpload)
