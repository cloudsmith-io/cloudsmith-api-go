...
// checks if the PythonUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PythonUpstream{}
...
func (o *PythonUpstream) SetIndexPackageCountNil() {
...
func (o *PythonUpstream) SetIndexStatusNil() {
...
func (o *PythonUpstream) SetLastIndexedNil() {
...
func (o PythonUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *PythonUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPythonUpstream)
