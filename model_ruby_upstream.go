...
type _RubyUpstream RubyUpstream
...
func (o *RubyUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varRubyUpstream := _RubyUpstream{}

	err = json.Unmarshal(data, &varRubyUpstream)

	if err != nil {
		return err
	}

	*o = RubyUpstream(varRubyUpstream)
