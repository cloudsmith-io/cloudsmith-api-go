...
type _DockerUpstreamRequestPatch DockerUpstreamRequestPatch
...
func (o *DockerUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varDockerUpstreamRequestPatch := _DockerUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varDockerUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = DockerUpstreamRequestPatch(varDockerUpstreamRequestPatch)
