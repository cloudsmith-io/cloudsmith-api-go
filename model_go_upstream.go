...
// checks if the GoUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GoUpstream{}

// GoUpstream struct for GoUpstream
...
func (o *GoUpstream) SetAuthSecretNil() {
...
func (o *GoUpstream) SetAuthUsernameNil() {
...
func (o *GoUpstream) SetExtraHeader1Nil() {
...
func (o *GoUpstream) SetExtraHeader2Nil() {
...
func (o *GoUpstream) SetExtraValue1Nil() {
...
func (o *GoUpstream) SetExtraValue2Nil() {
...
func (o GoUpstream) MarshalJSON() ([]byte, error) {
...
func (o GoUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *GoUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varGoUpstream := _GoUpstream{}

	err = json.Unmarshal(data, &varGoUpstream)

	if err != nil {
		return err
	}

	*o = GoUpstream(varGoUpstream)
...
type NullableGoUpstream struct {
	value *GoUpstream
	isSet bool
}

func (v NullableGoUpstream) Get() *GoUpstream {
	return v.value
}

func (v *NullableGoUpstream) Set(val *GoUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableGoUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableGoUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoUpstream(val *GoUpstream) *NullableGoUpstream {
	return &NullableGoUpstream{value: val, isSet: true}
}

func (v NullableGoUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
