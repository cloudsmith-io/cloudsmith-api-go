...
// checks if the DockerUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerUpstream{}

// DockerUpstream struct for DockerUpstream
type DockerUpstream struct {
...
type _DockerUpstream DockerUpstream
...
func (o *DockerUpstream) SetAuthSecretNil() {
...
func (o *DockerUpstream) SetAuthUsernameNil() {
...
func (o *DockerUpstream) SetExtraHeader1Nil() {
...
func (o *DockerUpstream) SetExtraHeader2Nil() {
...
func (o *DockerUpstream) SetExtraValue1Nil() {
...
func (o *DockerUpstream) SetExtraValue2Nil() {
...
func (o DockerUpstream) MarshalJSON() ([]byte, error) {
...
func (o DockerUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *DockerUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerUpstream := _DockerUpstream{}

	err = json.Unmarshal(data, &varDockerUpstream)

	if err != nil {
		return err
	}

	*o = DockerUpstream(varDockerUpstream)
...
type NullableDockerUpstream struct {
	value *DockerUpstream
	isSet bool
}

func (v NullableDockerUpstream) Get() *DockerUpstream {
	return v.value
}

func (v *NullableDockerUpstream) Set(val *DockerUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerUpstream(val *DockerUpstream) *NullableDockerUpstream {
	return &NullableDockerUpstream{value: val, isSet: true}
}

func (v NullableDockerUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
