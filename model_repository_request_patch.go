...
type _RepositoryRequestPatch RepositoryRequestPatch
...
func (o *RepositoryRequestPatch) SetOpenSourceLicenseNil() {
...
func (o *RepositoryRequestPatch) SetOpenSourceProjectUrlNil() {
...
func (o *RepositoryRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varRepositoryRequestPatch := _RepositoryRequestPatch{}

	err = json.Unmarshal(data, &varRepositoryRequestPatch)

	if err != nil {
		return err
	}

	*o = RepositoryRequestPatch(varRepositoryRequestPatch)
