...
// checks if the VsxPackageUploadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VsxPackageUploadRequest{}

// VsxPackageUploadRequest struct for VsxPackageUploadRequest
type VsxPackageUploadRequest struct {
...
type _VsxPackageUploadRequest VsxPackageUploadRequest
...
func (o *VsxPackageUploadRequest) SetTagsNil() {
	o.Tags.Set(nil)
}
...
func (o *VsxPackageUploadRequest) SetVulnerabilityCountsNil() {
...
func (o VsxPackageUploadRequest) MarshalJSON() ([]byte, error) {
...
func (o VsxPackageUploadRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VsxPackageUploadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVsxPackageUploadRequest := _VsxPackageUploadRequest{}

	err = json.Unmarshal(data, &varVsxPackageUploadRequest)

	if err != nil {
		return err
	}

	*o = VsxPackageUploadRequest(varVsxPackageUploadRequest)
...
type NullableVsxPackageUploadRequest struct {
	value *VsxPackageUploadRequest
	isSet bool
}

func (v NullableVsxPackageUploadRequest) Get() *VsxPackageUploadRequest {
	return v.value
}

func (v *NullableVsxPackageUploadRequest) Set(val *VsxPackageUploadRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVsxPackageUploadRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVsxPackageUploadRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVsxPackageUploadRequest(val *VsxPackageUploadRequest) *NullableVsxPackageUploadRequest {
	return &NullableVsxPackageUploadRequest{value: val, isSet: true}
}

func (v NullableVsxPackageUploadRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVsxPackageUploadRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
