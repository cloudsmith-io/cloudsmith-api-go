...
func (o PackagesUploadHelm) MarshalJSON() ([]byte, error) {
...
type NullablePackagesUploadHelm struct {
	value *PackagesUploadHelm
	isSet bool
}

func (v NullablePackagesUploadHelm) Get() *PackagesUploadHelm {
	return v.value
}

func (v *NullablePackagesUploadHelm) Set(val *PackagesUploadHelm) {
	v.value = val
	v.isSet = true
}

func (v NullablePackagesUploadHelm) IsSet() bool {
	return v.isSet
}

func (v *NullablePackagesUploadHelm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackagesUploadHelm(val *PackagesUploadHelm) *NullablePackagesUploadHelm {
	return &NullablePackagesUploadHelm{value: val, isSet: true}
}

func (v NullablePackagesUploadHelm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackagesUploadHelm) UnmarshalJSON(src []byte) error {
	v.isSet = true
