...
// checks if the GenericUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericUpstreamRequest{}

// GenericUpstreamRequest struct for GenericUpstreamRequest
type GenericUpstreamRequest struct {
...
type _GenericUpstreamRequest GenericUpstreamRequest
...
func (o *GenericUpstreamRequest) SetAuthSecretNil() {
...
func (o *GenericUpstreamRequest) SetAuthUsernameNil() {
...
func (o *GenericUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *GenericUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *GenericUpstreamRequest) SetExtraValue1Nil() {
...
func (o *GenericUpstreamRequest) SetExtraValue2Nil() {
...
func (o GenericUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o GenericUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GenericUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGenericUpstreamRequest := _GenericUpstreamRequest{}

	err = json.Unmarshal(data, &varGenericUpstreamRequest)

	if err != nil {
		return err
	}

	*o = GenericUpstreamRequest(varGenericUpstreamRequest)
...
type NullableGenericUpstreamRequest struct {
	value *GenericUpstreamRequest
	isSet bool
}

func (v NullableGenericUpstreamRequest) Get() *GenericUpstreamRequest {
	return v.value
}

func (v *NullableGenericUpstreamRequest) Set(val *GenericUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGenericUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGenericUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenericUpstreamRequest(val *GenericUpstreamRequest) *NullableGenericUpstreamRequest {
	return &NullableGenericUpstreamRequest{value: val, isSet: true}
}

func (v NullableGenericUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenericUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
