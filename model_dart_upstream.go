...
// checks if the DartUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DartUpstream{}

// DartUpstream struct for DartUpstream
type DartUpstream struct {
...
type _DartUpstream DartUpstream
...
func (o *DartUpstream) SetAuthSecretNil() {
...
func (o *DartUpstream) SetAuthUsernameNil() {
...
func (o *DartUpstream) SetExtraHeader1Nil() {
...
func (o *DartUpstream) SetExtraHeader2Nil() {
...
func (o *DartUpstream) SetExtraValue1Nil() {
...
func (o *DartUpstream) SetExtraValue2Nil() {
...
func (o *DartUpstream) SetIndexPackageCountNil() {
...
func (o *DartUpstream) SetIndexStatusNil() {
...
func (o *DartUpstream) SetLastIndexedNil() {
...
func (o DartUpstream) MarshalJSON() ([]byte, error) {
...
func (o DartUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *DartUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varDartUpstream := _DartUpstream{}

	err = json.Unmarshal(data, &varDartUpstream)

	if err != nil {
		return err
	}

	*o = DartUpstream(varDartUpstream)
...
type NullableDartUpstream struct {
	value *DartUpstream
	isSet bool
}

func (v NullableDartUpstream) Get() *DartUpstream {
	return v.value
}

func (v *NullableDartUpstream) Set(val *DartUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableDartUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableDartUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDartUpstream(val *DartUpstream) *NullableDartUpstream {
	return &NullableDartUpstream{value: val, isSet: true}
}

func (v NullableDartUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDartUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
