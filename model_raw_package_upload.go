...
// checks if the RawPackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RawPackageUpload{}
...
type _RawPackageUpload RawPackageUpload
...
func (o *RawPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *RawPackageUpload) SetRawLicenseNil() {
...
func (o *RawPackageUpload) SetSpdxLicenseNil() {
...
func (o *RawPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o RawPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *RawPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varRawPackageUpload := _RawPackageUpload{}

	err = json.Unmarshal(data, &varRawPackageUpload)

	if err != nil {
		return err
	}

	*o = RawPackageUpload(varRawPackageUpload)
