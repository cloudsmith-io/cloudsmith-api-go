...
// checks if the HexUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HexUpstreamRequestPatch{}

// HexUpstreamRequestPatch struct for HexUpstreamRequestPatch
type HexUpstreamRequestPatch struct {
...
type _HexUpstreamRequestPatch HexUpstreamRequestPatch
...
func (o *HexUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *HexUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *HexUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *HexUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *HexUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *HexUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o HexUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o HexUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *HexUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varHexUpstreamRequestPatch := _HexUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varHexUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = HexUpstreamRequestPatch(varHexUpstreamRequestPatch)
...
type NullableHexUpstreamRequestPatch struct {
	value *HexUpstreamRequestPatch
	isSet bool
}

func (v NullableHexUpstreamRequestPatch) Get() *HexUpstreamRequestPatch {
	return v.value
}

func (v *NullableHexUpstreamRequestPatch) Set(val *HexUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableHexUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableHexUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHexUpstreamRequestPatch(val *HexUpstreamRequestPatch) *NullableHexUpstreamRequestPatch {
	return &NullableHexUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableHexUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHexUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
