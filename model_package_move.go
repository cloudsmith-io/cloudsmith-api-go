...
// checks if the PackageMove type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackageMove{}

// PackageMove struct for PackageMove
...
func (o *PackageMove) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *PackageMove) SetDependenciesChecksumMd5Nil() {
...
func (o *PackageMove) SetDescriptionNil() {
...
func (o *PackageMove) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *PackageMove) SetEpochNil() {
	o.Epoch.Set(nil)
}
...
func (o *PackageMove) SetFilepathNil() {
	o.Filepath.Set(nil)
}
...
func (o *PackageMove) SetFullyQualifiedNameNil() {
...
func (o *PackageMove) SetLicenseNil() {
	o.License.Set(nil)
}
...
func (o *PackageMove) SetRawLicenseNil() {
...
func (o *PackageMove) SetReleaseNil() {
	o.Release.Set(nil)
}
...
func (o *PackageMove) SetSecurityScanCompletedAtNil() {
...
func (o *PackageMove) SetSecurityScanStartedAtNil() {
...
func (o *PackageMove) SetSecurityScanStatusNil() {
...
func (o *PackageMove) SetSecurityScanStatusUpdatedAtNil() {
...
func (o *PackageMove) SetSignatureUrlNil() {
...
func (o *PackageMove) SetSpdxLicenseNil() {
...
func (o *PackageMove) SetStatusReasonNil() {
...
func (o *PackageMove) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *PackageMove) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *PackageMove) SetSyncFinishedAtNil() {
...
func (o *PackageMove) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o *PackageMove) SetVulnerabilityCountsNil() {
...
func (o PackageMove) MarshalJSON() ([]byte, error) {
...
func (o PackageMove) ToMap() (map[string]interface{}, error) {
...
func (o *PackageMove) UnmarshalJSON(data []byte) (err error) {
	varPackageMove := _PackageMove{}

	err = json.Unmarshal(data, &varPackageMove)

	if err != nil {
		return err
	}

	*o = PackageMove(varPackageMove)
...
type NullablePackageMove struct {
	value *PackageMove
	isSet bool
}

func (v NullablePackageMove) Get() *PackageMove {
	return v.value
}

func (v *NullablePackageMove) Set(val *PackageMove) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageMove) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageMove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageMove(val *PackageMove) *NullablePackageMove {
	return &NullablePackageMove{value: val, isSet: true}
}

func (v NullablePackageMove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageMove) UnmarshalJSON(src []byte) error {
	v.isSet = true
