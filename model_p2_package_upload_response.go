...
// P2PackageUploadResponse struct for P2PackageUploadResponse
type P2PackageUploadResponse struct {
...
func (o *P2PackageUploadResponse) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *P2PackageUploadResponse) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *P2PackageUploadResponse) SetSecurityScanStatusNil() {
...
func (o *P2PackageUploadResponse) SetSignatureUrlNil() {
...
func (o P2PackageUploadResponse) MarshalJSON() ([]byte, error) {
...
type NullableP2PackageUploadResponse struct {
	value *P2PackageUploadResponse
	isSet bool
}

func (v NullableP2PackageUploadResponse) Get() *P2PackageUploadResponse {
	return v.value
}

func (v *NullableP2PackageUploadResponse) Set(val *P2PackageUploadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableP2PackageUploadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableP2PackageUploadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableP2PackageUploadResponse(val *P2PackageUploadResponse) *NullableP2PackageUploadResponse {
	return &NullableP2PackageUploadResponse{value: val, isSet: true}
}

func (v NullableP2PackageUploadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableP2PackageUploadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
