...
// checks if the RubyUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RubyUpstreamRequest{}

// RubyUpstreamRequest struct for RubyUpstreamRequest
type RubyUpstreamRequest struct {
...
type _RubyUpstreamRequest RubyUpstreamRequest
...
func (o *RubyUpstreamRequest) SetAuthSecretNil() {
...
func (o *RubyUpstreamRequest) SetAuthUsernameNil() {
...
func (o *RubyUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *RubyUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *RubyUpstreamRequest) SetExtraValue1Nil() {
...
func (o *RubyUpstreamRequest) SetExtraValue2Nil() {
...
func (o RubyUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o RubyUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RubyUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRubyUpstreamRequest := _RubyUpstreamRequest{}

	err = json.Unmarshal(data, &varRubyUpstreamRequest)

	if err != nil {
		return err
	}

	*o = RubyUpstreamRequest(varRubyUpstreamRequest)
...
type NullableRubyUpstreamRequest struct {
	value *RubyUpstreamRequest
	isSet bool
}

func (v NullableRubyUpstreamRequest) Get() *RubyUpstreamRequest {
	return v.value
}

func (v *NullableRubyUpstreamRequest) Set(val *RubyUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRubyUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRubyUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRubyUpstreamRequest(val *RubyUpstreamRequest) *NullableRubyUpstreamRequest {
	return &NullableRubyUpstreamRequest{value: val, isSet: true}
}

func (v NullableRubyUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRubyUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
