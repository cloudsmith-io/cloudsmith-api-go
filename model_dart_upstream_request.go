...
// checks if the DartUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DartUpstreamRequest{}

// DartUpstreamRequest struct for DartUpstreamRequest
type DartUpstreamRequest struct {
...
type _DartUpstreamRequest DartUpstreamRequest
...
func (o *DartUpstreamRequest) SetAuthSecretNil() {
...
func (o *DartUpstreamRequest) SetAuthUsernameNil() {
...
func (o *DartUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *DartUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *DartUpstreamRequest) SetExtraValue1Nil() {
...
func (o *DartUpstreamRequest) SetExtraValue2Nil() {
...
func (o DartUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o DartUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DartUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDartUpstreamRequest := _DartUpstreamRequest{}

	err = json.Unmarshal(data, &varDartUpstreamRequest)

	if err != nil {
		return err
	}

	*o = DartUpstreamRequest(varDartUpstreamRequest)
...
type NullableDartUpstreamRequest struct {
	value *DartUpstreamRequest
	isSet bool
}

func (v NullableDartUpstreamRequest) Get() *DartUpstreamRequest {
	return v.value
}

func (v *NullableDartUpstreamRequest) Set(val *DartUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDartUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDartUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDartUpstreamRequest(val *DartUpstreamRequest) *NullableDartUpstreamRequest {
	return &NullableDartUpstreamRequest{value: val, isSet: true}
}

func (v NullableDartUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDartUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
