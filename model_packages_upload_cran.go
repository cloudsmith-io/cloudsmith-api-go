...
// PackagesUploadCran struct for PackagesUploadCran
...
func (o PackagesUploadCran) MarshalJSON() ([]byte, error) {
...
type NullablePackagesUploadCran struct {
	value *PackagesUploadCran
	isSet bool
}

func (v NullablePackagesUploadCran) Get() *PackagesUploadCran {
	return v.value
}

func (v *NullablePackagesUploadCran) Set(val *PackagesUploadCran) {
	v.value = val
	v.isSet = true
}

func (v NullablePackagesUploadCran) IsSet() bool {
	return v.isSet
}

func (v *NullablePackagesUploadCran) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackagesUploadCran(val *PackagesUploadCran) *NullablePackagesUploadCran {
	return &NullablePackagesUploadCran{value: val, isSet: true}
}

func (v NullablePackagesUploadCran) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackagesUploadCran) UnmarshalJSON(src []byte) error {
	v.isSet = true
