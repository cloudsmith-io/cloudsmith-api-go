...
// checks if the HuggingfaceUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HuggingfaceUpstreamRequest{}

// HuggingfaceUpstreamRequest struct for HuggingfaceUpstreamRequest
type HuggingfaceUpstreamRequest struct {
...
type _HuggingfaceUpstreamRequest HuggingfaceUpstreamRequest
...
func NewHuggingfaceUpstreamRequest(name string, upstreamUrl string) *HuggingfaceUpstreamRequest {
	this := HuggingfaceUpstreamRequest{}
...
func (o *HuggingfaceUpstreamRequest) SetAuthSecretNil() {
...
func (o *HuggingfaceUpstreamRequest) SetAuthUsernameNil() {
...
func (o *HuggingfaceUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *HuggingfaceUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *HuggingfaceUpstreamRequest) SetExtraValue1Nil() {
...
func (o *HuggingfaceUpstreamRequest) SetExtraValue2Nil() {
...
func (o HuggingfaceUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o HuggingfaceUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *HuggingfaceUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varHuggingfaceUpstreamRequest := _HuggingfaceUpstreamRequest{}

	err = json.Unmarshal(data, &varHuggingfaceUpstreamRequest)

	if err != nil {
		return err
	}

	*o = HuggingfaceUpstreamRequest(varHuggingfaceUpstreamRequest)
...
type NullableHuggingfaceUpstreamRequest struct {
	value *HuggingfaceUpstreamRequest
	isSet bool
}

func (v NullableHuggingfaceUpstreamRequest) Get() *HuggingfaceUpstreamRequest {
	return v.value
}

func (v *NullableHuggingfaceUpstreamRequest) Set(val *HuggingfaceUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableHuggingfaceUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableHuggingfaceUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHuggingfaceUpstreamRequest(val *HuggingfaceUpstreamRequest) *NullableHuggingfaceUpstreamRequest {
	return &NullableHuggingfaceUpstreamRequest{value: val, isSet: true}
}

func (v NullableHuggingfaceUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHuggingfaceUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
