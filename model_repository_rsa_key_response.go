...
// RepositoryRsaKeyResponse struct for RepositoryRsaKeyResponse
type RepositoryRsaKeyResponse struct {
...
func (o RepositoryRsaKeyResponse) MarshalJSON() ([]byte, error) {
...
type NullableRepositoryRsaKeyResponse struct {
	value *RepositoryRsaKeyResponse
	isSet bool
}

func (v NullableRepositoryRsaKeyResponse) Get() *RepositoryRsaKeyResponse {
	return v.value
}

func (v *NullableRepositoryRsaKeyResponse) Set(val *RepositoryRsaKeyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoryRsaKeyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoryRsaKeyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoryRsaKeyResponse(val *RepositoryRsaKeyResponse) *NullableRepositoryRsaKeyResponse {
	return &NullableRepositoryRsaKeyResponse{value: val, isSet: true}
}

func (v NullableRepositoryRsaKeyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoryRsaKeyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
