...
*UserApi* | [**UserEmailsPartialUpdate**](docs/UserApi.md#useremailspartialupdate) | **Patch** /user/emails/{identifier}/ | 
*UserApi* | [**UserPassword**](docs/UserApi.md#userpassword) | **Put** /user/password/ | Views for the current user.
...
## Documentation For Models
 ...
 - [UserPasswordRequest](docs/UserPasswordRequest.md)
