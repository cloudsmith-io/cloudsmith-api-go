...
// checks if the RpmUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RpmUpstream{}

// RpmUpstream struct for RpmUpstream
...
func (o *RpmUpstream) SetAuthSecretNil() {
...
func (o *RpmUpstream) SetAuthUsernameNil() {
...
func (o *RpmUpstream) SetExtraHeader1Nil() {
...
func (o *RpmUpstream) SetExtraHeader2Nil() {
...
func (o *RpmUpstream) SetExtraValue1Nil() {
...
func (o *RpmUpstream) SetExtraValue2Nil() {
...
func (o *RpmUpstream) SetIndexStatusNil() {
...
func (o *RpmUpstream) SetLastIndexedNil() {
...
func (o RpmUpstream) MarshalJSON() ([]byte, error) {
...
func (o RpmUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *RpmUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varRpmUpstream := _RpmUpstream{}

	err = json.Unmarshal(data, &varRpmUpstream)

	if err != nil {
		return err
	}

	*o = RpmUpstream(varRpmUpstream)
...
type NullableRpmUpstream struct {
	value *RpmUpstream
	isSet bool
}

func (v NullableRpmUpstream) Get() *RpmUpstream {
	return v.value
}

func (v *NullableRpmUpstream) Set(val *RpmUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableRpmUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableRpmUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRpmUpstream(val *RpmUpstream) *NullableRpmUpstream {
	return &NullableRpmUpstream{value: val, isSet: true}
}

func (v NullableRpmUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRpmUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
