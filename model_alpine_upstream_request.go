...
// checks if the AlpineUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlpineUpstreamRequest{}

// AlpineUpstreamRequest struct for AlpineUpstreamRequest
type AlpineUpstreamRequest struct {
...
type _AlpineUpstreamRequest AlpineUpstreamRequest
...
func (o *AlpineUpstreamRequest) SetAuthSecretNil() {
...
func (o *AlpineUpstreamRequest) SetAuthUsernameNil() {
...
func (o *AlpineUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *AlpineUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *AlpineUpstreamRequest) SetExtraValue1Nil() {
...
func (o *AlpineUpstreamRequest) SetExtraValue2Nil() {
...
func (o AlpineUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o AlpineUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AlpineUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAlpineUpstreamRequest := _AlpineUpstreamRequest{}

	err = json.Unmarshal(data, &varAlpineUpstreamRequest)

	if err != nil {
		return err
	}

	*o = AlpineUpstreamRequest(varAlpineUpstreamRequest)
...
type NullableAlpineUpstreamRequest struct {
	value *AlpineUpstreamRequest
	isSet bool
}

func (v NullableAlpineUpstreamRequest) Get() *AlpineUpstreamRequest {
	return v.value
}

func (v *NullableAlpineUpstreamRequest) Set(val *AlpineUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAlpineUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAlpineUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlpineUpstreamRequest(val *AlpineUpstreamRequest) *NullableAlpineUpstreamRequest {
	return &NullableAlpineUpstreamRequest{value: val, isSet: true}
}

func (v NullableAlpineUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlpineUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
