...
type _PackageResync PackageResync
...
func (o *PackageResync) SetFilepathNil() {
	o.Filepath.Set(nil)
}
...
func (o *PackageResync) SetFullyQualifiedNameNil() {
...
func (o *PackageResync) SetRawLicenseNil() {
...
func (o *PackageResync) SetSpdxLicenseNil() {
...
func (o *PackageResync) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *PackageResync) SetVulnerabilityCountsNil() {
...
func (o *PackageResync) UnmarshalJSON(data []byte) (err error) {
	varPackageResync := _PackageResync{}

	err = json.Unmarshal(data, &varPackageResync)

	if err != nil {
		return err
	}

	*o = PackageResync(varPackageResync)
