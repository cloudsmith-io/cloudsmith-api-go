...
// checks if the AlpinePackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlpinePackageUpload{}
...
type _AlpinePackageUpload AlpinePackageUpload
...
func (o *AlpinePackageUpload) SetFullyQualifiedNameNil() {
...
func (o *AlpinePackageUpload) SetRawLicenseNil() {
...
func (o *AlpinePackageUpload) SetSpdxLicenseNil() {
...
func (o *AlpinePackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *AlpinePackageUpload) SetVulnerabilityCountsNil() {
...
func (o AlpinePackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AlpinePackageUpload) UnmarshalJSON(data []byte) (err error) {
	varAlpinePackageUpload := _AlpinePackageUpload{}

	err = json.Unmarshal(data, &varAlpinePackageUpload)

	if err != nil {
		return err
	}

	*o = AlpinePackageUpload(varAlpinePackageUpload)
