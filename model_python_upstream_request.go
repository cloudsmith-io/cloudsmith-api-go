...
// checks if the PythonUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PythonUpstreamRequest{}

// PythonUpstreamRequest struct for PythonUpstreamRequest
type PythonUpstreamRequest struct {
...
type _PythonUpstreamRequest PythonUpstreamRequest
...
func (o *PythonUpstreamRequest) SetAuthSecretNil() {
...
func (o *PythonUpstreamRequest) SetAuthUsernameNil() {
...
func (o *PythonUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *PythonUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *PythonUpstreamRequest) SetExtraValue1Nil() {
...
func (o *PythonUpstreamRequest) SetExtraValue2Nil() {
...
func (o PythonUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o PythonUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PythonUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPythonUpstreamRequest := _PythonUpstreamRequest{}

	err = json.Unmarshal(data, &varPythonUpstreamRequest)

	if err != nil {
		return err
	}

	*o = PythonUpstreamRequest(varPythonUpstreamRequest)
...
type NullablePythonUpstreamRequest struct {
	value *PythonUpstreamRequest
	isSet bool
}

func (v NullablePythonUpstreamRequest) Get() *PythonUpstreamRequest {
	return v.value
}

func (v *NullablePythonUpstreamRequest) Set(val *PythonUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePythonUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePythonUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePythonUpstreamRequest(val *PythonUpstreamRequest) *NullablePythonUpstreamRequest {
	return &NullablePythonUpstreamRequest{value: val, isSet: true}
}

func (v NullablePythonUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePythonUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
