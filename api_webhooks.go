...
// WebhooksCreateOpts Optional parameters for the method 'WebhooksCreate'
type WebhooksCreateOpts struct {
 ...
 * @param owner
 * @param repo
 * @param optional nil or *WebhooksCreateOpts - Optional Parameters:
 * @param "Data" (optional.Interface of WebhooksCreate) -
@return RepositoryWebhook
*/
func (a *WebhooksApiService) WebhooksCreate(ctx _context.Context, owner string, repo string, localVarOptionals *WebhooksCreateOpts) (RepositoryWebhook, *_nethttp.Response, error) {
	var (
 ...
 * @param identifier
*/
func (a *WebhooksApiService) WebhooksDelete(ctx _context.Context, owner string, repo string, identifier string) (*_nethttp.Response, error) {
	var (
...
@return []RepositoryWebhook
*/
func (a *WebhooksApiService) WebhooksList(ctx _context.Context, owner string, repo string, localVarOptionals *WebhooksListOpts) ([]RepositoryWebhook, *_nethttp.Response, error) {
	var (
...
// WebhooksPartialUpdateOpts Optional parameters for the method 'WebhooksPartialUpdate'
type WebhooksPartialUpdateOpts struct {
	Data optional.Interface
}
 ...
 * @param repo
 * @param identifier
 * @param optional nil or *WebhooksPartialUpdateOpts - Optional Parameters:
 * @param "Data" (optional.Interface of WebhooksPartialUpdate) -
@return RepositoryWebhook
*/
func (a *WebhooksApiService) WebhooksPartialUpdate(ctx _context.Context, owner string, repo string, identifier string, localVarOptionals *WebhooksPartialUpdateOpts) (RepositoryWebhook, *_nethttp.Response, error) {
	var (
...
@return RepositoryWebhook
*/
func (a *WebhooksApiService) WebhooksRead(ctx _context.Context, owner string, repo string, identifier string) (RepositoryWebhook, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
