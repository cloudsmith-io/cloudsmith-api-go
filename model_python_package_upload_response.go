...
// PythonPackageUploadResponse struct for PythonPackageUploadResponse
type PythonPackageUploadResponse struct {
...
func (o *PythonPackageUploadResponse) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *PythonPackageUploadResponse) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *PythonPackageUploadResponse) SetSecurityScanStatusNil() {
...
func (o *PythonPackageUploadResponse) SetSignatureUrlNil() {
...
func (o PythonPackageUploadResponse) MarshalJSON() ([]byte, error) {
...
type NullablePythonPackageUploadResponse struct {
	value *PythonPackageUploadResponse
	isSet bool
}

func (v NullablePythonPackageUploadResponse) Get() *PythonPackageUploadResponse {
	return v.value
}

func (v *NullablePythonPackageUploadResponse) Set(val *PythonPackageUploadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePythonPackageUploadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePythonPackageUploadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePythonPackageUploadResponse(val *PythonPackageUploadResponse) *NullablePythonPackageUploadResponse {
	return &NullablePythonPackageUploadResponse{value: val, isSet: true}
}

func (v NullablePythonPackageUploadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePythonPackageUploadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
