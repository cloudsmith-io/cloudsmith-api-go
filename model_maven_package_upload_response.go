...
// MavenPackageUploadResponse struct for MavenPackageUploadResponse
type MavenPackageUploadResponse struct {
...
func NewMavenPackageUploadResponse() *MavenPackageUploadResponse {
	this := MavenPackageUploadResponse{}
	return &this
}
...
func (o *MavenPackageUploadResponse) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *MavenPackageUploadResponse) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *MavenPackageUploadResponse) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *MavenPackageUploadResponse) SetPackagingNil() {
	o.Packaging.Set(nil)
}
...
func (o *MavenPackageUploadResponse) SetSecurityScanStatusNil() {
...
func (o *MavenPackageUploadResponse) SetSignatureUrlNil() {
...
func (o *MavenPackageUploadResponse) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o MavenPackageUploadResponse) MarshalJSON() ([]byte, error) {
...
type NullableMavenPackageUploadResponse struct {
	value *MavenPackageUploadResponse
	isSet bool
}

func (v NullableMavenPackageUploadResponse) Get() *MavenPackageUploadResponse {
	return v.value
}

func (v *NullableMavenPackageUploadResponse) Set(val *MavenPackageUploadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMavenPackageUploadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMavenPackageUploadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMavenPackageUploadResponse(val *MavenPackageUploadResponse) *NullableMavenPackageUploadResponse {
	return &NullableMavenPackageUploadResponse{value: val, isSet: true}
}

func (v NullableMavenPackageUploadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMavenPackageUploadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
