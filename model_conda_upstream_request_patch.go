...
// checks if the CondaUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CondaUpstreamRequestPatch{}

// CondaUpstreamRequestPatch struct for CondaUpstreamRequestPatch
type CondaUpstreamRequestPatch struct {
...
type _CondaUpstreamRequestPatch CondaUpstreamRequestPatch
...
func NewCondaUpstreamRequestPatch() *CondaUpstreamRequestPatch {
	this := CondaUpstreamRequestPatch{}
...
func (o *CondaUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *CondaUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *CondaUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *CondaUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *CondaUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o CondaUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o CondaUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *CondaUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varCondaUpstreamRequestPatch := _CondaUpstreamRequestPatch{}
	...
	*o = CondaUpstreamRequestPatch(varCondaUpstreamRequestPatch)
...
type NullableCondaUpstreamRequestPatch struct {
	value *CondaUpstreamRequestPatch
	isSet bool
}

func (v NullableCondaUpstreamRequestPatch) Get() *CondaUpstreamRequestPatch {
	return v.value
}

func (v *NullableCondaUpstreamRequestPatch) Set(val *CondaUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableCondaUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableCondaUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondaUpstreamRequestPatch(val *CondaUpstreamRequestPatch) *NullableCondaUpstreamRequestPatch {
	return &NullableCondaUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableCondaUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondaUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
