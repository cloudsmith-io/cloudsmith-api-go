...
// GoPackageUploadResponse struct for GoPackageUploadResponse
type GoPackageUploadResponse struct {
...
func (o *GoPackageUploadResponse) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *GoPackageUploadResponse) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *GoPackageUploadResponse) SetSecurityScanStatusNil() {
...
func (o *GoPackageUploadResponse) SetSignatureUrlNil() {
...
func (o GoPackageUploadResponse) MarshalJSON() ([]byte, error) {
...
type NullableGoPackageUploadResponse struct {
	value *GoPackageUploadResponse
	isSet bool
}

func (v NullableGoPackageUploadResponse) Get() *GoPackageUploadResponse {
	return v.value
}

func (v *NullableGoPackageUploadResponse) Set(val *GoPackageUploadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGoPackageUploadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGoPackageUploadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoPackageUploadResponse(val *GoPackageUploadResponse) *NullableGoPackageUploadResponse {
	return &NullableGoPackageUploadResponse{value: val, isSet: true}
}

func (v NullableGoPackageUploadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoPackageUploadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
