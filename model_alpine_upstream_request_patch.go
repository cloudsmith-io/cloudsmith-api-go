...
// checks if the AlpineUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlpineUpstreamRequestPatch{}

// AlpineUpstreamRequestPatch struct for AlpineUpstreamRequestPatch
type AlpineUpstreamRequestPatch struct {
...
type _AlpineUpstreamRequestPatch AlpineUpstreamRequestPatch
...
func NewAlpineUpstreamRequestPatch() *AlpineUpstreamRequestPatch {
	this := AlpineUpstreamRequestPatch{}
...
func (o *AlpineUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *AlpineUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *AlpineUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *AlpineUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *AlpineUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *AlpineUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o *AlpineUpstreamRequestPatch) SetRsaKeyUrlNil() {
	o.RsaKeyUrl.Set(nil)
}
...
func (o AlpineUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o AlpineUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *AlpineUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varAlpineUpstreamRequestPatch := _AlpineUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varAlpineUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = AlpineUpstreamRequestPatch(varAlpineUpstreamRequestPatch)
...
type NullableAlpineUpstreamRequestPatch struct {
	value *AlpineUpstreamRequestPatch
	isSet bool
}

func (v NullableAlpineUpstreamRequestPatch) Get() *AlpineUpstreamRequestPatch {
	return v.value
}

func (v *NullableAlpineUpstreamRequestPatch) Set(val *AlpineUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAlpineUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAlpineUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlpineUpstreamRequestPatch(val *AlpineUpstreamRequestPatch) *NullableAlpineUpstreamRequestPatch {
	return &NullableAlpineUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableAlpineUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlpineUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
