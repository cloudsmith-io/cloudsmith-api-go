...
// PackagesUploadMaven struct for PackagesUploadMaven
...
func (o PackagesUploadMaven) MarshalJSON() ([]byte, error) {
...
type NullablePackagesUploadMaven struct {
	value *PackagesUploadMaven
	isSet bool
}

func (v NullablePackagesUploadMaven) Get() *PackagesUploadMaven {
	return v.value
}

func (v *NullablePackagesUploadMaven) Set(val *PackagesUploadMaven) {
	v.value = val
	v.isSet = true
}

func (v NullablePackagesUploadMaven) IsSet() bool {
	return v.isSet
}

func (v *NullablePackagesUploadMaven) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackagesUploadMaven(val *PackagesUploadMaven) *NullablePackagesUploadMaven {
	return &NullablePackagesUploadMaven{value: val, isSet: true}
}

func (v NullablePackagesUploadMaven) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackagesUploadMaven) UnmarshalJSON(src []byte) error {
	v.isSet = true
