...
func (o PackagesUploadGo) MarshalJSON() ([]byte, error) {
...
type NullablePackagesUploadGo struct {
	value *PackagesUploadGo
	isSet bool
}

func (v NullablePackagesUploadGo) Get() *PackagesUploadGo {
	return v.value
}

func (v *NullablePackagesUploadGo) Set(val *PackagesUploadGo) {
	v.value = val
	v.isSet = true
}

func (v NullablePackagesUploadGo) IsSet() bool {
	return v.isSet
}

func (v *NullablePackagesUploadGo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackagesUploadGo(val *PackagesUploadGo) *NullablePackagesUploadGo {
	return &NullablePackagesUploadGo{value: val, isSet: true}
}

func (v NullablePackagesUploadGo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackagesUploadGo) UnmarshalJSON(src []byte) error {
	v.isSet = true
