...
type _P2PackageUpload P2PackageUpload
...
func (o *P2PackageUpload) SetFullyQualifiedNameNil() {
...
func (o *P2PackageUpload) SetRawLicenseNil() {
...
func (o *P2PackageUpload) SetSpdxLicenseNil() {
...
func (o *P2PackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *P2PackageUpload) SetVulnerabilityCountsNil() {
...
func (o *P2PackageUpload) UnmarshalJSON(data []byte) (err error) {
	varP2PackageUpload := _P2PackageUpload{}

	err = json.Unmarshal(data, &varP2PackageUpload)

	if err != nil {
		return err
	}

	*o = P2PackageUpload(varP2PackageUpload)
