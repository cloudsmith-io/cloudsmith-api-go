...
`func (o *VagrantPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *VagrantPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *VagrantPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *VagrantPackageUpload) HasDisplaySource() bool`
