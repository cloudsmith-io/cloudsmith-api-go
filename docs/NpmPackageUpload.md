...
`func (o *NpmPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *NpmPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *NpmPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *NpmPackageUpload) HasDisplaySource() bool`
