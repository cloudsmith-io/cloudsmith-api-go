...
**Location** | Pointer to **string** | The city/town/area your organization is based in. | [optional] 
**Name** | Pointer to **string** | A descriptive name for your organization. | [optional] 
