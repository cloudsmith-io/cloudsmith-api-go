...
`func (o *DartPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *DartPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *DartPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *DartPackageUpload) HasDisplaySource() bool`
