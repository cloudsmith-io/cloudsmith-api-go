...
`func (o *DebPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *DebPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *DebPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *DebPackageUpload) HasDisplaySource() bool`
