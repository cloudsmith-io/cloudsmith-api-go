...
`func (o *GenericUpstream) SetIndexStatusNil(b bool)`

 SetIndexStatusNil sets the value for IndexStatus to be an explicit nil

### UnsetIndexStatus
`func (o *GenericUpstream) UnsetIndexStatus()`
...
`func (o *GenericUpstream) SetLastIndexedNil(b bool)`

 SetLastIndexedNil sets the value for LastIndexed to be an explicit nil

### UnsetLastIndexed
`func (o *GenericUpstream) UnsetLastIndexed()`
