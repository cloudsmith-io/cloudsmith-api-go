...
`func NewCargoUpstreamRequestWithDefaults() *CargoUpstreamRequest`
...
`func (o *CargoUpstreamRequest) SetAuthSecretNil(b bool)`
...
`func (o *CargoUpstreamRequest) HasExtraValue2() bool`
