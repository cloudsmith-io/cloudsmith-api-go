...
`func (o *GoPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *GoPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *GoPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *GoPackageUpload) HasDisplaySource() bool`
