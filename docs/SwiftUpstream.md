...
`func (o *SwiftUpstream) SetIndexStatusNil(b bool)`

 SetIndexStatusNil sets the value for IndexStatus to be an explicit nil

### UnsetIndexStatus
`func (o *SwiftUpstream) UnsetIndexStatus()`
...
`func (o *SwiftUpstream) SetLastIndexedNil(b bool)`

 SetLastIndexedNil sets the value for LastIndexed to be an explicit nil

### UnsetLastIndexed
`func (o *SwiftUpstream) UnsetLastIndexed()`
