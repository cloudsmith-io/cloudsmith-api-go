...
`func (o *CranUpstream) HasAvailable() bool`
...
`func (o *CranUpstream) HasCanReindex() bool`
...
`func (o *CranUpstream) SetDisableReasonText(v string)`

SetDisableReasonText sets DisableReasonText field to given value.

### HasDisableReasonText

`func (o *CranUpstream) HasDisableReasonText() bool`
...
`func (o *CranUpstream) GetLastIndexed() string`

GetLastIndexed returns the LastIndexed field if non-nil, zero value otherwise.

### GetLastIndexedOk

`func (o *CranUpstream) GetLastIndexedOk() (*string, bool)`
