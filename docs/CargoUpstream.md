...
`func (o *CargoUpstream) SetIndexPackageCount(v int64)`
...
`func (o *CargoUpstream) SetIndexStatusNil(b bool)`

 SetIndexStatusNil sets the value for IndexStatus to be an explicit nil

### UnsetIndexStatus
`func (o *CargoUpstream) UnsetIndexStatus()`
...
`func (o *CargoUpstream) SetLastIndexedNil(b bool)`

 SetLastIndexedNil sets the value for LastIndexed to be an explicit nil

### UnsetLastIndexed
`func (o *CargoUpstream) UnsetLastIndexed()`
