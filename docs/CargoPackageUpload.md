...
`func (o *CargoPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *CargoPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *CargoPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *CargoPackageUpload) HasDisplaySource() bool`
