...
`func (o *PythonUpstream) SetIndexPackageCount(v int64)`
...
`func (o *PythonUpstream) SetIndexStatusNil(b bool)`

 SetIndexStatusNil sets the value for IndexStatus to be an explicit nil

### UnsetIndexStatus
`func (o *PythonUpstream) UnsetIndexStatus()`
...
`func (o *PythonUpstream) SetLastIndexedNil(b bool)`

 SetLastIndexedNil sets the value for LastIndexed to be an explicit nil

### UnsetLastIndexed
`func (o *PythonUpstream) UnsetLastIndexed()`
