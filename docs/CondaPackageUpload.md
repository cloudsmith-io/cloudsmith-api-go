...
`func (o *CondaPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *CondaPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *CondaPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *CondaPackageUpload) HasDisplaySource() bool`
