...
`func (o *RubyUpstream) SetIndexPackageCount(v int64)`
...
`func (o *RubyUpstream) SetIndexStatusNil(b bool)`

 SetIndexStatusNil sets the value for IndexStatus to be an explicit nil

### UnsetIndexStatus
`func (o *RubyUpstream) UnsetIndexStatus()`
...
`func (o *RubyUpstream) SetLastIndexedNil(b bool)`

 SetLastIndexedNil sets the value for LastIndexed to be an explicit nil

### UnsetLastIndexed
`func (o *RubyUpstream) UnsetLastIndexed()`
