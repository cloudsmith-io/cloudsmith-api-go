...
`func (o *NpmUpstreamRequestPatch) SetAuthSecretNil(b bool)`
...
`func (o *NpmUpstreamRequestPatch) GetTrustLevel() string`

GetTrustLevel returns the TrustLevel field if non-nil, zero value otherwise.

### GetTrustLevelOk

`func (o *NpmUpstreamRequestPatch) GetTrustLevelOk() (*string, bool)`
...
`func (o *NpmUpstreamRequestPatch) SetTrustLevel(v string)`

SetTrustLevel sets TrustLevel field to given value.

### HasTrustLevel

`func (o *NpmUpstreamRequestPatch) HasTrustLevel() bool`
