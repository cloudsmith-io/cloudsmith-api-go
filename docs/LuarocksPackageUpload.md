...
`func (o *LuarocksPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *LuarocksPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *LuarocksPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *LuarocksPackageUpload) HasDisplaySource() bool`
