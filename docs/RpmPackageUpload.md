...
`func (o *RpmPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *RpmPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *RpmPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *RpmPackageUpload) HasDisplaySource() bool`
