...
`func (o *PackageMove) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *PackageMove) GetDisplaySourceOk() (*string, bool)`
...
`func (o *PackageMove) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *PackageMove) HasDisplaySource() bool`
