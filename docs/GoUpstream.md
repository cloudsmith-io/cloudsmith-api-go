...
`func (o *GoUpstream) SetIndexPackageCount(v int64)`
...
`func (o *GoUpstream) SetLastIndexedNil(b bool)`

 SetLastIndexedNil sets the value for LastIndexed to be an explicit nil

### UnsetLastIndexed
`func (o *GoUpstream) UnsetLastIndexed()`
