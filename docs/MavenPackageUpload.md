...
`func (o *MavenPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *MavenPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *MavenPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *MavenPackageUpload) HasDisplaySource() bool`
