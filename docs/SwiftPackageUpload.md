...
`func (o *SwiftPackageUpload) GetIsHidden() bool`

GetIsHidden returns the IsHidden field if non-nil, zero value otherwise.

### GetIsHiddenOk

`func (o *SwiftPackageUpload) GetIsHiddenOk() (*bool, bool)`
...
`func (o *SwiftPackageUpload) SetIsHidden(v bool)`
...
`func (o *SwiftPackageUpload) GetOsiApproved() bool`

GetOsiApproved returns the OsiApproved field if non-nil, zero value otherwise.

### GetOsiApprovedOk

`func (o *SwiftPackageUpload) GetOsiApprovedOk() (*bool, bool)`
...
`func (o *SwiftPackageUpload) SetOsiApproved(v bool)`

SetOsiApproved sets OsiApproved field to given value.

### HasOsiApproved

`func (o *SwiftPackageUpload) HasOsiApproved() bool`
...
`func (o *SwiftPackageUpload) GetRawLicense() string`

GetRawLicense returns the RawLicense field if non-nil, zero value otherwise.

### GetRawLicenseOk

`func (o *SwiftPackageUpload) GetRawLicenseOk() (*string, bool)`
...
`func (o *SwiftPackageUpload) SetRawLicense(v string)`

SetRawLicense sets RawLicense field to given value.

### HasRawLicense

`func (o *SwiftPackageUpload) HasRawLicense() bool`

HasRawLicense returns a boolean if a field has been set.

### SetRawLicenseNil

`func (o *SwiftPackageUpload) SetRawLicenseNil(b bool)`

 SetRawLicenseNil sets the value for RawLicense to be an explicit nil

### UnsetRawLicense
`func (o *SwiftPackageUpload) UnsetRawLicense()`
...
`func (o *SwiftPackageUpload) GetSelfWebappUrl() string`

GetSelfWebappUrl returns the SelfWebappUrl field if non-nil, zero value otherwise.

### GetSelfWebappUrlOk

`func (o *SwiftPackageUpload) GetSelfWebappUrlOk() (*string, bool)`
...
`func (o *SwiftPackageUpload) SetSelfWebappUrl(v string)`

SetSelfWebappUrl sets SelfWebappUrl field to given value.

### HasSelfWebappUrl

`func (o *SwiftPackageUpload) HasSelfWebappUrl() bool`
...
`func (o *SwiftPackageUpload) GetSpdxLicense() string`

GetSpdxLicense returns the SpdxLicense field if non-nil, zero value otherwise.

### GetSpdxLicenseOk

`func (o *SwiftPackageUpload) GetSpdxLicenseOk() (*string, bool)`
...
`func (o *SwiftPackageUpload) SetSpdxLicense(v string)`

SetSpdxLicense sets SpdxLicense field to given value.

### HasSpdxLicense

`func (o *SwiftPackageUpload) HasSpdxLicense() bool`

HasSpdxLicense returns a boolean if a field has been set.

### SetSpdxLicenseNil

`func (o *SwiftPackageUpload) SetSpdxLicenseNil(b bool)`

 SetSpdxLicenseNil sets the value for SpdxLicense to be an explicit nil

### UnsetSpdxLicense
`func (o *SwiftPackageUpload) UnsetSpdxLicense()`
...
`func (o *SwiftPackageUpload) GetStorePath() string`

GetStorePath returns the StorePath field if non-nil, zero value otherwise.

### GetStorePathOk

`func (o *SwiftPackageUpload) GetStorePathOk() (*string, bool)`
...
`func (o *SwiftPackageUpload) SetStorePath(v string)`

SetStorePath sets StorePath field to given value.

### HasStorePath

`func (o *SwiftPackageUpload) HasStorePath() bool`

HasStorePath returns a boolean if a field has been set.

### SetStorePathNil

`func (o *SwiftPackageUpload) SetStorePathNil(b bool)`

 SetStorePathNil sets the value for StorePath to be an explicit nil

### UnsetStorePath
`func (o *SwiftPackageUpload) UnsetStorePath()`
...
`func (o *SwiftPackageUpload) GetTagsAutomatic() map[string]interface{}`

GetTagsAutomatic returns the TagsAutomatic field if non-nil, zero value otherwise.

### GetTagsAutomaticOk

`func (o *SwiftPackageUpload) GetTagsAutomaticOk() (*map[string]interface{}, bool)`
...
`func (o *SwiftPackageUpload) SetTagsAutomatic(v map[string]interface{})`

SetTagsAutomatic sets TagsAutomatic field to given value.

### HasTagsAutomatic

`func (o *SwiftPackageUpload) HasTagsAutomatic() bool`
...
`func (o *SwiftPackageUpload) GetTagsStatic() map[string][]string`

GetTagsStatic returns the TagsStatic field if non-nil, zero value otherwise.

### GetTagsStaticOk

`func (o *SwiftPackageUpload) GetTagsStaticOk() (*map[string][]string, bool)`
...
`func (o *SwiftPackageUpload) SetTagsStatic(v map[string][]string)`

SetTagsStatic sets TagsStatic field to given value.

### HasTagsStatic

`func (o *SwiftPackageUpload) HasTagsStatic() bool`
