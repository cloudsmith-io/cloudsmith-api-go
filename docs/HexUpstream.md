...
`func (o *HexUpstream) SetIndexStatusNil(b bool)`

 SetIndexStatusNil sets the value for IndexStatus to be an explicit nil

### UnsetIndexStatus
`func (o *HexUpstream) UnsetIndexStatus()`
...
`func (o *HexUpstream) SetLastIndexedNil(b bool)`

 SetLastIndexedNil sets the value for LastIndexed to be an explicit nil

### UnsetLastIndexed
`func (o *HexUpstream) UnsetLastIndexed()`
