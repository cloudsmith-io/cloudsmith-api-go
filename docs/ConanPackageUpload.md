...
`func (o *ConanPackageUpload) GetDisplaySource() string`

GetDisplaySource returns the DisplaySource field if non-nil, zero value otherwise.

### GetDisplaySourceOk

`func (o *ConanPackageUpload) GetDisplaySourceOk() (*string, bool)`
...
`func (o *ConanPackageUpload) SetDisplaySource(v string)`

SetDisplaySource sets DisplaySource field to given value.

### HasDisplaySource

`func (o *ConanPackageUpload) HasDisplaySource() bool`
