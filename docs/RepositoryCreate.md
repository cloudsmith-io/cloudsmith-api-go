...
`func (o *RepositoryCreate) GetRepositoryType() string`

GetRepositoryType returns the RepositoryType field if non-nil, zero value otherwise.

### GetRepositoryTypeOk

`func (o *RepositoryCreate) GetRepositoryTypeOk() (*string, bool)`
...
`func (o *RepositoryCreate) SetRepositoryType(v string)`
