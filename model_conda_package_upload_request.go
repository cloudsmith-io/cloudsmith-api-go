...
// checks if the CondaPackageUploadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CondaPackageUploadRequest{}
...
type _CondaPackageUploadRequest CondaPackageUploadRequest
...
func (o *CondaPackageUploadRequest) SetVulnerabilityCountsNil() {
...
func (o CondaPackageUploadRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CondaPackageUploadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCondaPackageUploadRequest := _CondaPackageUploadRequest{}

	err = json.Unmarshal(data, &varCondaPackageUploadRequest)

	if err != nil {
		return err
	}

	*o = CondaPackageUploadRequest(varCondaPackageUploadRequest)
