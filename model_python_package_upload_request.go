...
// checks if the PythonPackageUploadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PythonPackageUploadRequest{}

// PythonPackageUploadRequest struct for PythonPackageUploadRequest
type PythonPackageUploadRequest struct {
...
type _PythonPackageUploadRequest PythonPackageUploadRequest
...
func (o *PythonPackageUploadRequest) SetTagsNil() {
	o.Tags.Set(nil)
}
...
func (o *PythonPackageUploadRequest) SetVulnerabilityCountsNil() {
...
func (o PythonPackageUploadRequest) MarshalJSON() ([]byte, error) {
...
func (o PythonPackageUploadRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PythonPackageUploadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPythonPackageUploadRequest := _PythonPackageUploadRequest{}

	err = json.Unmarshal(data, &varPythonPackageUploadRequest)

	if err != nil {
		return err
	}

	*o = PythonPackageUploadRequest(varPythonPackageUploadRequest)
...
type NullablePythonPackageUploadRequest struct {
	value *PythonPackageUploadRequest
	isSet bool
}

func (v NullablePythonPackageUploadRequest) Get() *PythonPackageUploadRequest {
	return v.value
}

func (v *NullablePythonPackageUploadRequest) Set(val *PythonPackageUploadRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePythonPackageUploadRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePythonPackageUploadRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePythonPackageUploadRequest(val *PythonPackageUploadRequest) *NullablePythonPackageUploadRequest {
	return &NullablePythonPackageUploadRequest{value: val, isSet: true}
}

func (v NullablePythonPackageUploadRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePythonPackageUploadRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
