...
// checks if the CargoPackageUploadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CargoPackageUploadRequest{}
...
type _CargoPackageUploadRequest CargoPackageUploadRequest
...
func (o *CargoPackageUploadRequest) SetVulnerabilityCountsNil() {
...
func (o CargoPackageUploadRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CargoPackageUploadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCargoPackageUploadRequest := _CargoPackageUploadRequest{}

	err = json.Unmarshal(data, &varCargoPackageUploadRequest)

	if err != nil {
		return err
	}

	*o = CargoPackageUploadRequest(varCargoPackageUploadRequest)
