...
// checks if the CargoUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CargoUpstreamRequestPatch{}

// CargoUpstreamRequestPatch struct for CargoUpstreamRequestPatch
type CargoUpstreamRequestPatch struct {
...
type _CargoUpstreamRequestPatch CargoUpstreamRequestPatch
...
func NewCargoUpstreamRequestPatch() *CargoUpstreamRequestPatch {
	this := CargoUpstreamRequestPatch{}
...
func (o *CargoUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *CargoUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *CargoUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *CargoUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *CargoUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *CargoUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o CargoUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o CargoUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *CargoUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varCargoUpstreamRequestPatch := _CargoUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varCargoUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = CargoUpstreamRequestPatch(varCargoUpstreamRequestPatch)
...
type NullableCargoUpstreamRequestPatch struct {
	value *CargoUpstreamRequestPatch
	isSet bool
}

func (v NullableCargoUpstreamRequestPatch) Get() *CargoUpstreamRequestPatch {
	return v.value
}

func (v *NullableCargoUpstreamRequestPatch) Set(val *CargoUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableCargoUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableCargoUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCargoUpstreamRequestPatch(val *CargoUpstreamRequestPatch) *NullableCargoUpstreamRequestPatch {
	return &NullableCargoUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableCargoUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCargoUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
