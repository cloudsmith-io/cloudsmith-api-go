...
// checks if the VsxPackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VsxPackageUpload{}

// VsxPackageUpload struct for VsxPackageUpload
type VsxPackageUpload struct {
...
type _VsxPackageUpload VsxPackageUpload
...
func (o *VsxPackageUpload) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *VsxPackageUpload) SetDependenciesChecksumMd5Nil() {
...
func (o *VsxPackageUpload) SetDescriptionNil() {
...
func (o *VsxPackageUpload) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *VsxPackageUpload) SetEpochNil() {
	o.Epoch.Set(nil)
}
...
func (o *VsxPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *VsxPackageUpload) SetLicenseNil() {
	o.License.Set(nil)
}
...
func (o *VsxPackageUpload) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *VsxPackageUpload) SetRawLicenseNil() {
...
func (o *VsxPackageUpload) SetReleaseNil() {
	o.Release.Set(nil)
}
...
func (o *VsxPackageUpload) SetSecurityScanCompletedAtNil() {
...
func (o *VsxPackageUpload) SetSecurityScanStartedAtNil() {
...
func (o *VsxPackageUpload) SetSecurityScanStatusNil() {
...
func (o *VsxPackageUpload) SetSecurityScanStatusUpdatedAtNil() {
...
func (o *VsxPackageUpload) SetSignatureUrlNil() {
...
func (o *VsxPackageUpload) SetSpdxLicenseNil() {
...
func (o *VsxPackageUpload) SetStatusReasonNil() {
...
func (o *VsxPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *VsxPackageUpload) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *VsxPackageUpload) SetSyncFinishedAtNil() {
...
func (o *VsxPackageUpload) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o *VsxPackageUpload) SetVulnerabilityCountsNil() {
...
func (o VsxPackageUpload) MarshalJSON() ([]byte, error) {
...
func (o VsxPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *VsxPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varVsxPackageUpload := _VsxPackageUpload{}

	err = json.Unmarshal(data, &varVsxPackageUpload)

	if err != nil {
		return err
	}

	*o = VsxPackageUpload(varVsxPackageUpload)
...
type NullableVsxPackageUpload struct {
	value *VsxPackageUpload
	isSet bool
}

func (v NullableVsxPackageUpload) Get() *VsxPackageUpload {
	return v.value
}

func (v *NullableVsxPackageUpload) Set(val *VsxPackageUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableVsxPackageUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableVsxPackageUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVsxPackageUpload(val *VsxPackageUpload) *NullableVsxPackageUpload {
	return &NullableVsxPackageUpload{value: val, isSet: true}
}

func (v NullableVsxPackageUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVsxPackageUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
