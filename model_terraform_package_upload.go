...
// checks if the TerraformPackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TerraformPackageUpload{}

// TerraformPackageUpload struct for TerraformPackageUpload
type TerraformPackageUpload struct {
...
type _TerraformPackageUpload TerraformPackageUpload
...
func (o *TerraformPackageUpload) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *TerraformPackageUpload) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *TerraformPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *TerraformPackageUpload) SetRawLicenseNil() {
...
func (o *TerraformPackageUpload) SetSecurityScanStatusNil() {
...
func (o *TerraformPackageUpload) SetSignatureUrlNil() {
...
func (o *TerraformPackageUpload) SetSpdxLicenseNil() {
...
func (o *TerraformPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *TerraformPackageUpload) SetVulnerabilityCountsNil() {
...
func (o TerraformPackageUpload) MarshalJSON() ([]byte, error) {
...
func (o TerraformPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *TerraformPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varTerraformPackageUpload := _TerraformPackageUpload{}

	err = json.Unmarshal(data, &varTerraformPackageUpload)

	if err != nil {
		return err
	}

	*o = TerraformPackageUpload(varTerraformPackageUpload)
...
type NullableTerraformPackageUpload struct {
	value *TerraformPackageUpload
	isSet bool
}

func (v NullableTerraformPackageUpload) Get() *TerraformPackageUpload {
	return v.value
}

func (v *NullableTerraformPackageUpload) Set(val *TerraformPackageUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableTerraformPackageUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableTerraformPackageUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTerraformPackageUpload(val *TerraformPackageUpload) *NullableTerraformPackageUpload {
	return &NullableTerraformPackageUpload{value: val, isSet: true}
}

func (v NullableTerraformPackageUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTerraformPackageUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
