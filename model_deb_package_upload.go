...
type _DebPackageUpload DebPackageUpload
...
func (o *DebPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *DebPackageUpload) SetRawLicenseNil() {
...
func (o *DebPackageUpload) SetSpdxLicenseNil() {
...
func (o *DebPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *DebPackageUpload) SetVulnerabilityCountsNil() {
...
func (o *DebPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varDebPackageUpload := _DebPackageUpload{}

	err = json.Unmarshal(data, &varDebPackageUpload)

	if err != nil {
		return err
	}

	*o = DebPackageUpload(varDebPackageUpload)
