...
// checks if the HuggingfaceUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HuggingfaceUpstream{}

// HuggingfaceUpstream struct for HuggingfaceUpstream
...
type _HuggingfaceUpstream HuggingfaceUpstream
...
func (o *HuggingfaceUpstream) SetAuthSecretNil() {
...
func (o *HuggingfaceUpstream) SetAuthUsernameNil() {
...
func (o *HuggingfaceUpstream) SetExtraHeader1Nil() {
...
func (o *HuggingfaceUpstream) SetExtraHeader2Nil() {
...
func (o *HuggingfaceUpstream) SetExtraValue1Nil() {
...
func (o *HuggingfaceUpstream) SetExtraValue2Nil() {
...
func (o *HuggingfaceUpstream) SetIndexPackageCountNil() {
...
func (o *HuggingfaceUpstream) SetIndexStatusNil() {
...
func (o *HuggingfaceUpstream) SetLastIndexedNil() {
...
func (o HuggingfaceUpstream) MarshalJSON() ([]byte, error) {
...
func (o HuggingfaceUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *HuggingfaceUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varHuggingfaceUpstream := _HuggingfaceUpstream{}

	err = json.Unmarshal(data, &varHuggingfaceUpstream)

	if err != nil {
		return err
	}

	*o = HuggingfaceUpstream(varHuggingfaceUpstream)
...
type NullableHuggingfaceUpstream struct {
	value *HuggingfaceUpstream
	isSet bool
}

func (v NullableHuggingfaceUpstream) Get() *HuggingfaceUpstream {
	return v.value
}

func (v *NullableHuggingfaceUpstream) Set(val *HuggingfaceUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableHuggingfaceUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableHuggingfaceUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHuggingfaceUpstream(val *HuggingfaceUpstream) *NullableHuggingfaceUpstream {
	return &NullableHuggingfaceUpstream{value: val, isSet: true}
}

func (v NullableHuggingfaceUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHuggingfaceUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
