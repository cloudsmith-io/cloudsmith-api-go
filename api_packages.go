...
type ApiPackagesUploadGenericRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
	data       *GenericPackageUploadRequest
}

func (r ApiPackagesUploadGenericRequest) Data(data GenericPackageUploadRequest) ApiPackagesUploadGenericRequest {
	r.data = &data
	return r
}

func (r ApiPackagesUploadGenericRequest) Execute() (*GenericPackageUpload, *http.Response, error) {
	return r.ApiService.PackagesUploadGenericExecute(r)
}
...
Create a new Generic package
 ...
 @param owner
 @param repo
 @return ApiPackagesUploadGenericRequest
*/
func (a *PackagesApiService) PackagesUploadGeneric(ctx context.Context, owner string, repo string) ApiPackagesUploadGenericRequest {
	return ApiPackagesUploadGenericRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
func (a *PackagesApiService) PackagesUploadGenericExecute(r ApiPackagesUploadGenericRequest) (*GenericPackageUpload, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GenericPackageUpload
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesUploadGeneric")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/upload/generic/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
type ApiPackagesUploadMcpRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
	data       *McpPackageUploadRequest
}

func (r ApiPackagesUploadMcpRequest) Data(data McpPackageUploadRequest) ApiPackagesUploadMcpRequest {
	r.data = &data
	return r
}

func (r ApiPackagesUploadMcpRequest) Execute() (*McpPackageUpload, *http.Response, error) {
	return r.ApiService.PackagesUploadMcpExecute(r)
}
...
Create a new MCP package
 ...
 @param owner
 @param repo
 @return ApiPackagesUploadMcpRequest
*/
func (a *PackagesApiService) PackagesUploadMcp(ctx context.Context, owner string, repo string) ApiPackagesUploadMcpRequest {
	return ApiPackagesUploadMcpRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
func (a *PackagesApiService) PackagesUploadMcpExecute(r ApiPackagesUploadMcpRequest) (*McpPackageUpload, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *McpPackageUpload
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesUploadMcp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/upload/mcp/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
type ApiPackagesUploadNixRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
	data       *NixPackageUploadRequest
}

func (r ApiPackagesUploadNixRequest) Data(data NixPackageUploadRequest) ApiPackagesUploadNixRequest {
	r.data = &data
	return r
}

func (r ApiPackagesUploadNixRequest) Execute() (*NixPackageUpload, *http.Response, error) {
	return r.ApiService.PackagesUploadNixExecute(r)
}

/*
PackagesUploadNix Create a new Nix package
...
Create a new Nix package
 ...
 @param owner
 @param repo
 @return ApiPackagesUploadNixRequest
*/
func (a *PackagesApiService) PackagesUploadNix(ctx context.Context, owner string, repo string) ApiPackagesUploadNixRequest {
	return ApiPackagesUploadNixRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
func (a *PackagesApiService) PackagesUploadNixExecute(r ApiPackagesUploadNixRequest) (*NixPackageUpload, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *NixPackageUpload
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesUploadNix")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/upload/nix/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
type ApiPackagesUploadVsxRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
	data       *VsxPackageUploadRequest
}

func (r ApiPackagesUploadVsxRequest) Data(data VsxPackageUploadRequest) ApiPackagesUploadVsxRequest {
	r.data = &data
	return r
}

func (r ApiPackagesUploadVsxRequest) Execute() (*VsxPackageUpload, *http.Response, error) {
	return r.ApiService.PackagesUploadVsxExecute(r)
}
...
func (a *PackagesApiService) PackagesUploadVsxExecute(r ApiPackagesUploadVsxRequest) (*VsxPackageUpload, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *VsxPackageUpload
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesUploadVsx")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/upload/vsx/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
type ApiPackagesValidateUploadGenericRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
...
func (r ApiPackagesValidateUploadGenericRequest) Data(data GenericPackageUploadRequest) ApiPackagesValidateUploadGenericRequest {
	r.data = &data
	return r
}

func (r ApiPackagesValidateUploadGenericRequest) Execute() (*http.Response, error) {
	return r.ApiService.PackagesValidateUploadGenericExecute(r)
}
...
Validate parameters for create Generic package
 ...
 @param owner
 @param repo
 @return ApiPackagesValidateUploadGenericRequest
*/
func (a *PackagesApiService) PackagesValidateUploadGeneric(ctx context.Context, owner string, repo string) ApiPackagesValidateUploadGenericRequest {
	return ApiPackagesValidateUploadGenericRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
// Execute executes the request
func (a *PackagesApiService) PackagesValidateUploadGenericExecute(r ApiPackagesValidateUploadGenericRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesValidateUploadGeneric")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/validate-upload/generic/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
type ApiPackagesValidateUploadMcpRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
...
func (r ApiPackagesValidateUploadMcpRequest) Data(data McpPackageUploadRequest) ApiPackagesValidateUploadMcpRequest {
	r.data = &data
	return r
}

func (r ApiPackagesValidateUploadMcpRequest) Execute() (*http.Response, error) {
	return r.ApiService.PackagesValidateUploadMcpExecute(r)
}
...
Validate parameters for create MCP package
 ...
 @param owner
 @param repo
 @return ApiPackagesValidateUploadMcpRequest
*/
func (a *PackagesApiService) PackagesValidateUploadMcp(ctx context.Context, owner string, repo string) ApiPackagesValidateUploadMcpRequest {
	return ApiPackagesValidateUploadMcpRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
// Execute executes the request
func (a *PackagesApiService) PackagesValidateUploadMcpExecute(r ApiPackagesValidateUploadMcpRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesValidateUploadMcp")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/validate-upload/mcp/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
type ApiPackagesValidateUploadNixRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
...
func (r ApiPackagesValidateUploadNixRequest) Data(data NixPackageUploadRequest) ApiPackagesValidateUploadNixRequest {
	r.data = &data
	return r
}

func (r ApiPackagesValidateUploadNixRequest) Execute() (*http.Response, error) {
	return r.ApiService.PackagesValidateUploadNixExecute(r)
}

/*
PackagesValidateUploadNix Validate parameters for create Nix package
...
Validate parameters for create Nix package
 ...
 @param owner
 @param repo
 @return ApiPackagesValidateUploadNixRequest
*/
func (a *PackagesApiService) PackagesValidateUploadNix(ctx context.Context, owner string, repo string) ApiPackagesValidateUploadNixRequest {
	return ApiPackagesValidateUploadNixRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
// Execute executes the request
func (a *PackagesApiService) PackagesValidateUploadNixExecute(r ApiPackagesValidateUploadNixRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesValidateUploadNix")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/validate-upload/nix/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
...
type ApiPackagesValidateUploadVsxRequest struct {
	ctx        context.Context
	ApiService *PackagesApiService
	owner      string
	repo       string
...
func (r ApiPackagesValidateUploadVsxRequest) Data(data VsxPackageUploadRequest) ApiPackagesValidateUploadVsxRequest {
	r.data = &data
	return r
}

func (r ApiPackagesValidateUploadVsxRequest) Execute() (*http.Response, error) {
	return r.ApiService.PackagesValidateUploadVsxExecute(r)
}
...
Validate parameters for create VSX package
 ...
 @param owner
 @param repo
 @return ApiPackagesValidateUploadVsxRequest
*/
func (a *PackagesApiService) PackagesValidateUploadVsx(ctx context.Context, owner string, repo string) ApiPackagesValidateUploadVsxRequest {
	return ApiPackagesValidateUploadVsxRequest{
		ApiService: a,
		ctx:        ctx,
		owner:      owner,
...
// Execute executes the request
func (a *PackagesApiService) PackagesValidateUploadVsxExecute(r ApiPackagesValidateUploadVsxRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesApiService.PackagesValidateUploadVsx")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/packages/{owner}/{repo}/validate-upload/vsx/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", url.PathEscape(parameterValueToString(r.owner, "owner")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo"+"}", url.PathEscape(parameterValueToString(r.repo, "repo")), -1)
