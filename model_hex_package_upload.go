...
// checks if the HexPackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HexPackageUpload{}
...
type _HexPackageUpload HexPackageUpload
...
func (o *HexPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *HexPackageUpload) SetRawLicenseNil() {
...
func (o *HexPackageUpload) SetSpdxLicenseNil() {
...
func (o *HexPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o HexPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *HexPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varHexPackageUpload := _HexPackageUpload{}

	err = json.Unmarshal(data, &varHexPackageUpload)

	if err != nil {
		return err
	}

	*o = HexPackageUpload(varHexPackageUpload)
