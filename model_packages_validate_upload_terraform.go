...
func (o PackagesValidateUploadTerraform) MarshalJSON() ([]byte, error) {
...
type NullablePackagesValidateUploadTerraform struct {
	value *PackagesValidateUploadTerraform
	isSet bool
}

func (v NullablePackagesValidateUploadTerraform) Get() *PackagesValidateUploadTerraform {
	return v.value
}

func (v *NullablePackagesValidateUploadTerraform) Set(val *PackagesValidateUploadTerraform) {
	v.value = val
	v.isSet = true
}

func (v NullablePackagesValidateUploadTerraform) IsSet() bool {
	return v.isSet
}

func (v *NullablePackagesValidateUploadTerraform) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackagesValidateUploadTerraform(val *PackagesValidateUploadTerraform) *NullablePackagesValidateUploadTerraform {
	return &NullablePackagesValidateUploadTerraform{value: val, isSet: true}
}

func (v NullablePackagesValidateUploadTerraform) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackagesValidateUploadTerraform) UnmarshalJSON(src []byte) error {
	v.isSet = true
