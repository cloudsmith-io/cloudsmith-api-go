...
type _PackageQuarantine PackageQuarantine
...
func (o *PackageQuarantine) SetFullyQualifiedNameNil() {
...
func (o *PackageQuarantine) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *PackageQuarantine) UnmarshalJSON(data []byte) (err error) {
	varPackageQuarantine := _PackageQuarantine{}

	err = json.Unmarshal(data, &varPackageQuarantine)

	if err != nil {
		return err
	}

	*o = PackageQuarantine(varPackageQuarantine)
