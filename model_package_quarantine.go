...
// checks if the PackageQuarantine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackageQuarantine{}

// PackageQuarantine struct for PackageQuarantine
type PackageQuarantine struct {
...
func (o *PackageQuarantine) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *PackageQuarantine) SetDependenciesChecksumMd5Nil() {
...
func (o *PackageQuarantine) SetDescriptionNil() {
...
func (o *PackageQuarantine) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *PackageQuarantine) SetEpochNil() {
	o.Epoch.Set(nil)
}
...
func (o *PackageQuarantine) SetLicenseNil() {
	o.License.Set(nil)
}
...
func (o *PackageQuarantine) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *PackageQuarantine) SetSecurityScanCompletedAtNil() {
...
func (o *PackageQuarantine) SetSecurityScanStartedAtNil() {
...
func (o *PackageQuarantine) SetSecurityScanStatusNil() {
...
func (o *PackageQuarantine) SetSecurityScanStatusUpdatedAtNil() {
...
func (o *PackageQuarantine) SetSignatureUrlNil() {
...
func (o *PackageQuarantine) SetStatusReasonNil() {
...
func (o *PackageQuarantine) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *PackageQuarantine) SetSyncFinishedAtNil() {
...
func (o *PackageQuarantine) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o PackageQuarantine) MarshalJSON() ([]byte, error) {
...
func (o PackageQuarantine) ToMap() (map[string]interface{}, error) {
...
type NullablePackageQuarantine struct {
	value *PackageQuarantine
	isSet bool
}

func (v NullablePackageQuarantine) Get() *PackageQuarantine {
	return v.value
}

func (v *NullablePackageQuarantine) Set(val *PackageQuarantine) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageQuarantine) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageQuarantine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageQuarantine(val *PackageQuarantine) *NullablePackageQuarantine {
	return &NullablePackageQuarantine{value: val, isSet: true}
}

func (v NullablePackageQuarantine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageQuarantine) UnmarshalJSON(src []byte) error {
	v.isSet = true
