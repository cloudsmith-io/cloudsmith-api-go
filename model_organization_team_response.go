...
// OrganizationTeamResponse struct for OrganizationTeamResponse
...
func (o OrganizationTeamResponse) MarshalJSON() ([]byte, error) {
...
type NullableOrganizationTeamResponse struct {
	value *OrganizationTeamResponse
	isSet bool
}

func (v NullableOrganizationTeamResponse) Get() *OrganizationTeamResponse {
	return v.value
}

func (v *NullableOrganizationTeamResponse) Set(val *OrganizationTeamResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationTeamResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationTeamResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationTeamResponse(val *OrganizationTeamResponse) *NullableOrganizationTeamResponse {
	return &NullableOrganizationTeamResponse{value: val, isSet: true}
}

func (v NullableOrganizationTeamResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationTeamResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
