...
// checks if the SwiftUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwiftUpstream{}

// SwiftUpstream struct for SwiftUpstream
type SwiftUpstream struct {
...
type _SwiftUpstream SwiftUpstream
...
func (o *SwiftUpstream) SetAuthSecretNil() {
...
func (o *SwiftUpstream) SetAuthUsernameNil() {
...
func (o *SwiftUpstream) SetExtraHeader1Nil() {
...
func (o *SwiftUpstream) SetExtraHeader2Nil() {
...
func (o *SwiftUpstream) SetExtraValue1Nil() {
...
func (o *SwiftUpstream) SetExtraValue2Nil() {
...
func (o SwiftUpstream) MarshalJSON() ([]byte, error) {
...
func (o SwiftUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *SwiftUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varSwiftUpstream := _SwiftUpstream{}

	err = json.Unmarshal(data, &varSwiftUpstream)

	if err != nil {
		return err
	}

	*o = SwiftUpstream(varSwiftUpstream)
...
type NullableSwiftUpstream struct {
	value *SwiftUpstream
	isSet bool
}

func (v NullableSwiftUpstream) Get() *SwiftUpstream {
	return v.value
}

func (v *NullableSwiftUpstream) Set(val *SwiftUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableSwiftUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableSwiftUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwiftUpstream(val *SwiftUpstream) *NullableSwiftUpstream {
	return &NullableSwiftUpstream{value: val, isSet: true}
}

func (v NullableSwiftUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwiftUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
