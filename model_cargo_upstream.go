...
// checks if the CargoUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CargoUpstream{}

// CargoUpstream struct for CargoUpstream
...
type _CargoUpstream CargoUpstream
...
func (o *CargoUpstream) SetAuthSecretNil() {
...
func (o *CargoUpstream) SetAuthUsernameNil() {
...
func (o *CargoUpstream) SetExtraHeader1Nil() {
...
func (o *CargoUpstream) SetExtraHeader2Nil() {
...
func (o *CargoUpstream) SetExtraValue1Nil() {
...
func (o *CargoUpstream) SetExtraValue2Nil() {
...
func (o CargoUpstream) MarshalJSON() ([]byte, error) {
...
func (o CargoUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *CargoUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varCargoUpstream := _CargoUpstream{}

	err = json.Unmarshal(data, &varCargoUpstream)

	if err != nil {
		return err
	}

	*o = CargoUpstream(varCargoUpstream)
...
type NullableCargoUpstream struct {
	value *CargoUpstream
	isSet bool
}

func (v NullableCargoUpstream) Get() *CargoUpstream {
	return v.value
}

func (v *NullableCargoUpstream) Set(val *CargoUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableCargoUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableCargoUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCargoUpstream(val *CargoUpstream) *NullableCargoUpstream {
	return &NullableCargoUpstream{value: val, isSet: true}
}

func (v NullableCargoUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCargoUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
