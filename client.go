...
// APIClient manages communication with the Cloudsmith API (v1) API v1.1351.3
...
type APIClient struct {
	...
	BulkActionApi *BulkActionApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BulkActionApi = (*BulkActionApiService)(&c.common)
