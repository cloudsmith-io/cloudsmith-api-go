...
// checks if the NugetPackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NugetPackageUpload{}

// NugetPackageUpload struct for NugetPackageUpload
type NugetPackageUpload struct {
...
type _NugetPackageUpload NugetPackageUpload
...
func (o *NugetPackageUpload) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *NugetPackageUpload) SetDependenciesChecksumMd5Nil() {
...
func (o *NugetPackageUpload) SetDescriptionNil() {
...
func (o *NugetPackageUpload) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *NugetPackageUpload) SetEpochNil() {
	o.Epoch.Set(nil)
}
...
func (o *NugetPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *NugetPackageUpload) SetLicenseNil() {
	o.License.Set(nil)
}
...
func (o *NugetPackageUpload) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *NugetPackageUpload) SetRawLicenseNil() {
...
func (o *NugetPackageUpload) SetReleaseNil() {
	o.Release.Set(nil)
}
...
func (o *NugetPackageUpload) SetSecurityScanCompletedAtNil() {
...
func (o *NugetPackageUpload) SetSecurityScanStartedAtNil() {
...
func (o *NugetPackageUpload) SetSecurityScanStatusNil() {
...
func (o *NugetPackageUpload) SetSecurityScanStatusUpdatedAtNil() {
...
func (o *NugetPackageUpload) SetSignatureUrlNil() {
...
func (o *NugetPackageUpload) SetSpdxLicenseNil() {
...
func (o *NugetPackageUpload) SetStatusReasonNil() {
...
func (o *NugetPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *NugetPackageUpload) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *NugetPackageUpload) SetSyncFinishedAtNil() {
...
func (o *NugetPackageUpload) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o *NugetPackageUpload) SetVulnerabilityCountsNil() {
...
func (o NugetPackageUpload) MarshalJSON() ([]byte, error) {
...
func (o NugetPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *NugetPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varNugetPackageUpload := _NugetPackageUpload{}

	err = json.Unmarshal(data, &varNugetPackageUpload)

	if err != nil {
		return err
	}

	*o = NugetPackageUpload(varNugetPackageUpload)
...
type NullableNugetPackageUpload struct {
	value *NugetPackageUpload
	isSet bool
}

func (v NullableNugetPackageUpload) Get() *NugetPackageUpload {
	return v.value
}

func (v *NullableNugetPackageUpload) Set(val *NugetPackageUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableNugetPackageUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableNugetPackageUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNugetPackageUpload(val *NugetPackageUpload) *NullableNugetPackageUpload {
	return &NullableNugetPackageUpload{value: val, isSet: true}
}

func (v NullableNugetPackageUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNugetPackageUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
