...
// checks if the GoPackageUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GoPackageUpload{}

// GoPackageUpload struct for GoPackageUpload
type GoPackageUpload struct {
...
type _GoPackageUpload GoPackageUpload
...
func (o *GoPackageUpload) SetCdnUrlNil() {
	o.CdnUrl.Set(nil)
}
...
func (o *GoPackageUpload) SetDependenciesChecksumMd5Nil() {
...
func (o *GoPackageUpload) SetDescriptionNil() {
...
func (o *GoPackageUpload) SetDistroNil() {
	o.Distro.Set(nil)
}
...
func (o *GoPackageUpload) SetEpochNil() {
	o.Epoch.Set(nil)
}
...
func (o *GoPackageUpload) SetFullyQualifiedNameNil() {
...
func (o *GoPackageUpload) SetLicenseNil() {
	o.License.Set(nil)
}
...
func (o *GoPackageUpload) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *GoPackageUpload) SetRawLicenseNil() {
...
func (o *GoPackageUpload) SetReleaseNil() {
	o.Release.Set(nil)
}
...
func (o *GoPackageUpload) SetSecurityScanCompletedAtNil() {
...
func (o *GoPackageUpload) SetSecurityScanStartedAtNil() {
...
func (o *GoPackageUpload) SetSecurityScanStatusNil() {
...
func (o *GoPackageUpload) SetSecurityScanStatusUpdatedAtNil() {
...
func (o *GoPackageUpload) SetSignatureUrlNil() {
...
func (o *GoPackageUpload) SetSpdxLicenseNil() {
...
func (o *GoPackageUpload) SetStatusReasonNil() {
...
func (o *GoPackageUpload) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *GoPackageUpload) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *GoPackageUpload) SetSyncFinishedAtNil() {
...
func (o *GoPackageUpload) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o *GoPackageUpload) SetVulnerabilityCountsNil() {
...
func (o GoPackageUpload) MarshalJSON() ([]byte, error) {
...
func (o GoPackageUpload) ToMap() (map[string]interface{}, error) {
...
func (o *GoPackageUpload) UnmarshalJSON(data []byte) (err error) {
	varGoPackageUpload := _GoPackageUpload{}

	err = json.Unmarshal(data, &varGoPackageUpload)

	if err != nil {
		return err
	}

	*o = GoPackageUpload(varGoPackageUpload)
...
type NullableGoPackageUpload struct {
	value *GoPackageUpload
	isSet bool
}

func (v NullableGoPackageUpload) Get() *GoPackageUpload {
	return v.value
}

func (v *NullableGoPackageUpload) Set(val *GoPackageUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableGoPackageUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableGoPackageUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoPackageUpload(val *GoPackageUpload) *NullableGoPackageUpload {
	return &NullableGoPackageUpload{value: val, isSet: true}
}

func (v NullableGoPackageUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoPackageUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
