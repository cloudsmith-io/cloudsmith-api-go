...
// checks if the CondaUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CondaUpstream{}

// CondaUpstream struct for CondaUpstream
type CondaUpstream struct {
...
type _CondaUpstream CondaUpstream
...
func (o *CondaUpstream) SetAuthSecretNil() {
...
func (o *CondaUpstream) SetAuthUsernameNil() {
...
func (o *CondaUpstream) SetExtraHeader1Nil() {
...
func (o *CondaUpstream) SetExtraHeader2Nil() {
...
func (o *CondaUpstream) SetExtraValue1Nil() {
...
func (o *CondaUpstream) SetExtraValue2Nil() {
...
func (o *CondaUpstream) SetIndexPackageCountNil() {
...
func (o *CondaUpstream) SetIndexStatusNil() {
...
func (o *CondaUpstream) SetLastIndexedNil() {
...
func (o CondaUpstream) MarshalJSON() ([]byte, error) {
...
func (o CondaUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *CondaUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varCondaUpstream := _CondaUpstream{}

	err = json.Unmarshal(data, &varCondaUpstream)

	if err != nil {
		return err
	}

	*o = CondaUpstream(varCondaUpstream)
...
type NullableCondaUpstream struct {
	value *CondaUpstream
	isSet bool
}

func (v NullableCondaUpstream) Get() *CondaUpstream {
	return v.value
}

func (v *NullableCondaUpstream) Set(val *CondaUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableCondaUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableCondaUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondaUpstream(val *CondaUpstream) *NullableCondaUpstream {
	return &NullableCondaUpstream{value: val, isSet: true}
}

func (v NullableCondaUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondaUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
