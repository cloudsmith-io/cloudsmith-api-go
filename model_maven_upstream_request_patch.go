...
// checks if the MavenUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MavenUpstreamRequestPatch{}

// MavenUpstreamRequestPatch struct for MavenUpstreamRequestPatch
type MavenUpstreamRequestPatch struct {
...
type _MavenUpstreamRequestPatch MavenUpstreamRequestPatch
...
func (o *MavenUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *MavenUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *MavenUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *MavenUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *MavenUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *MavenUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o MavenUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o MavenUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *MavenUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varMavenUpstreamRequestPatch := _MavenUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varMavenUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = MavenUpstreamRequestPatch(varMavenUpstreamRequestPatch)
...
type NullableMavenUpstreamRequestPatch struct {
	value *MavenUpstreamRequestPatch
	isSet bool
}

func (v NullableMavenUpstreamRequestPatch) Get() *MavenUpstreamRequestPatch {
	return v.value
}

func (v *NullableMavenUpstreamRequestPatch) Set(val *MavenUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableMavenUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableMavenUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMavenUpstreamRequestPatch(val *MavenUpstreamRequestPatch) *NullableMavenUpstreamRequestPatch {
	return &NullableMavenUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableMavenUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMavenUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
