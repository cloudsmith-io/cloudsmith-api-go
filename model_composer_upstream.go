...
// checks if the ComposerUpstream type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComposerUpstream{}

// ComposerUpstream struct for ComposerUpstream
type ComposerUpstream struct {
...
type _ComposerUpstream ComposerUpstream
...
func (o *ComposerUpstream) SetAuthSecretNil() {
...
func (o *ComposerUpstream) SetAuthUsernameNil() {
...
func (o *ComposerUpstream) SetExtraHeader1Nil() {
...
func (o *ComposerUpstream) SetExtraHeader2Nil() {
...
func (o *ComposerUpstream) SetExtraValue1Nil() {
...
func (o *ComposerUpstream) SetExtraValue2Nil() {
...
func (o *ComposerUpstream) SetIndexStatusNil() {
...
func (o *ComposerUpstream) SetLastIndexedNil() {
...
func (o ComposerUpstream) MarshalJSON() ([]byte, error) {
...
func (o ComposerUpstream) ToMap() (map[string]interface{}, error) {
...
func (o *ComposerUpstream) UnmarshalJSON(data []byte) (err error) {
	...
	varComposerUpstream := _ComposerUpstream{}

	err = json.Unmarshal(data, &varComposerUpstream)

	if err != nil {
		return err
	}

	*o = ComposerUpstream(varComposerUpstream)
...
type NullableComposerUpstream struct {
	value *ComposerUpstream
	isSet bool
}

func (v NullableComposerUpstream) Get() *ComposerUpstream {
	return v.value
}

func (v *NullableComposerUpstream) Set(val *ComposerUpstream) {
	v.value = val
	v.isSet = true
}

func (v NullableComposerUpstream) IsSet() bool {
	return v.isSet
}

func (v *NullableComposerUpstream) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComposerUpstream(val *ComposerUpstream) *NullableComposerUpstream {
	return &NullableComposerUpstream{value: val, isSet: true}
}

func (v NullableComposerUpstream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComposerUpstream) UnmarshalJSON(src []byte) error {
	v.isSet = true
