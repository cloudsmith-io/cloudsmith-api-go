...
// checks if the CommonBandwidthMetrics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonBandwidthMetrics{}
...
type _CommonBandwidthMetrics CommonBandwidthMetrics
...
func (o CommonBandwidthMetrics) ToMap() (map[string]interface{}, error) {
...
func (o *CommonBandwidthMetrics) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonBandwidthMetrics := _CommonBandwidthMetrics{}

	err = json.Unmarshal(data, &varCommonBandwidthMetrics)

	if err != nil {
		return err
	}

	*o = CommonBandwidthMetrics(varCommonBandwidthMetrics)
