...
// checks if the RubyUpstreamRequestPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RubyUpstreamRequestPatch{}

// RubyUpstreamRequestPatch struct for RubyUpstreamRequestPatch
type RubyUpstreamRequestPatch struct {
...
type _RubyUpstreamRequestPatch RubyUpstreamRequestPatch
...
func (o *RubyUpstreamRequestPatch) SetAuthSecretNil() {
...
func (o *RubyUpstreamRequestPatch) SetAuthUsernameNil() {
...
func (o *RubyUpstreamRequestPatch) SetExtraHeader1Nil() {
...
func (o *RubyUpstreamRequestPatch) SetExtraHeader2Nil() {
...
func (o *RubyUpstreamRequestPatch) SetExtraValue1Nil() {
...
func (o *RubyUpstreamRequestPatch) SetExtraValue2Nil() {
...
func (o RubyUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
...
func (o RubyUpstreamRequestPatch) ToMap() (map[string]interface{}, error) {
...
func (o *RubyUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varRubyUpstreamRequestPatch := _RubyUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varRubyUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = RubyUpstreamRequestPatch(varRubyUpstreamRequestPatch)
...
type NullableRubyUpstreamRequestPatch struct {
	value *RubyUpstreamRequestPatch
	isSet bool
}

func (v NullableRubyUpstreamRequestPatch) Get() *RubyUpstreamRequestPatch {
	return v.value
}

func (v *NullableRubyUpstreamRequestPatch) Set(val *RubyUpstreamRequestPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableRubyUpstreamRequestPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableRubyUpstreamRequestPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRubyUpstreamRequestPatch(val *RubyUpstreamRequestPatch) *NullableRubyUpstreamRequestPatch {
	return &NullableRubyUpstreamRequestPatch{value: val, isSet: true}
}

func (v NullableRubyUpstreamRequestPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRubyUpstreamRequestPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
