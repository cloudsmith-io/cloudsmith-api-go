...
// NamespaceAuditLogResponse struct for NamespaceAuditLogResponse
type NamespaceAuditLogResponse struct {
...
func NewNamespaceAuditLogResponse(actor NullableString, actorIpAddress NullableString, actorLocation GeoIpLocation, actorSlugPerm NullableString, context string, event string, eventAt time.Time, object string, objectKind string, objectSlugPerm string, target string, targetKind string) *NamespaceAuditLogResponse {
	this := NamespaceAuditLogResponse{}
	this.Actor = actor
...
func (o *NamespaceAuditLogResponse) SetActorUrlNil() {
	o.ActorUrl.Set(nil)
}
...
func (o *NamespaceAuditLogResponse) SetTargetSlugPermNil() {
...
func (o NamespaceAuditLogResponse) MarshalJSON() ([]byte, error) {
...
type NullableNamespaceAuditLogResponse struct {
	value *NamespaceAuditLogResponse
	isSet bool
}

func (v NullableNamespaceAuditLogResponse) Get() *NamespaceAuditLogResponse {
	return v.value
}

func (v *NullableNamespaceAuditLogResponse) Set(val *NamespaceAuditLogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNamespaceAuditLogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNamespaceAuditLogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamespaceAuditLogResponse(val *NamespaceAuditLogResponse) *NullableNamespaceAuditLogResponse {
	return &NullableNamespaceAuditLogResponse{value: val, isSet: true}
}

func (v NullableNamespaceAuditLogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamespaceAuditLogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
