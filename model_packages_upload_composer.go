...
// PackagesUploadComposer struct for PackagesUploadComposer
...
func (o PackagesUploadComposer) MarshalJSON() ([]byte, error) {
...
type NullablePackagesUploadComposer struct {
	value *PackagesUploadComposer
	isSet bool
}

func (v NullablePackagesUploadComposer) Get() *PackagesUploadComposer {
	return v.value
}

func (v *NullablePackagesUploadComposer) Set(val *PackagesUploadComposer) {
	v.value = val
	v.isSet = true
}

func (v NullablePackagesUploadComposer) IsSet() bool {
	return v.isSet
}

func (v *NullablePackagesUploadComposer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackagesUploadComposer(val *PackagesUploadComposer) *NullablePackagesUploadComposer {
	return &NullablePackagesUploadComposer{value: val, isSet: true}
}

func (v NullablePackagesUploadComposer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackagesUploadComposer) UnmarshalJSON(src []byte) error {
	v.isSet = true
