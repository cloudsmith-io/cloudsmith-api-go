...
type _DartUpstreamRequestPatch DartUpstreamRequestPatch
...
func (o *DartUpstreamRequestPatch) UnmarshalJSON(data []byte) (err error) {
	varDartUpstreamRequestPatch := _DartUpstreamRequestPatch{}

	err = json.Unmarshal(data, &varDartUpstreamRequestPatch)

	if err != nil {
		return err
	}

	*o = DartUpstreamRequestPatch(varDartUpstreamRequestPatch)
