...
// checks if the ComposerUpstreamRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComposerUpstreamRequest{}

// ComposerUpstreamRequest struct for ComposerUpstreamRequest
type ComposerUpstreamRequest struct {
...
type _ComposerUpstreamRequest ComposerUpstreamRequest
...
func (o *ComposerUpstreamRequest) SetAuthSecretNil() {
...
func (o *ComposerUpstreamRequest) SetAuthUsernameNil() {
...
func (o *ComposerUpstreamRequest) SetExtraHeader1Nil() {
...
func (o *ComposerUpstreamRequest) SetExtraHeader2Nil() {
...
func (o *ComposerUpstreamRequest) SetExtraValue1Nil() {
...
func (o *ComposerUpstreamRequest) SetExtraValue2Nil() {
...
func (o ComposerUpstreamRequest) MarshalJSON() ([]byte, error) {
...
func (o ComposerUpstreamRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ComposerUpstreamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varComposerUpstreamRequest := _ComposerUpstreamRequest{}

	err = json.Unmarshal(data, &varComposerUpstreamRequest)

	if err != nil {
		return err
	}

	*o = ComposerUpstreamRequest(varComposerUpstreamRequest)
...
type NullableComposerUpstreamRequest struct {
	value *ComposerUpstreamRequest
	isSet bool
}

func (v NullableComposerUpstreamRequest) Get() *ComposerUpstreamRequest {
	return v.value
}

func (v *NullableComposerUpstreamRequest) Set(val *ComposerUpstreamRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableComposerUpstreamRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableComposerUpstreamRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComposerUpstreamRequest(val *ComposerUpstreamRequest) *NullableComposerUpstreamRequest {
	return &NullableComposerUpstreamRequest{value: val, isSet: true}
}

func (v NullableComposerUpstreamRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComposerUpstreamRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
